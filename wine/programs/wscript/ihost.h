/*** Autogenerated by WIDL 8.6 from programs/wscript/ihost.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IArguments2_QueryInterface(IArguments2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IArguments2_AddRef(IArguments2* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IArguments2_Release(IArguments2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IArguments2_GetTypeInfoCount(IArguments2* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IArguments2_GetTypeInfo(IArguments2* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IArguments2_GetIDsOfNames(IArguments2* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IArguments2_Invoke(IArguments2* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IArguments2 methods ***/
static __WIDL_INLINE HRESULT IArguments2_Item(IArguments2* This,LONG Index,BSTR *out_Value) {
    return This->lpVtbl->Item(This,Index,out_Value);
}
static __WIDL_INLINE HRESULT IArguments2_Count(IArguments2* This,LONG *out_Count) {
    return This->lpVtbl->Count(This,out_Count);
}
static __WIDL_INLINE HRESULT IArguments2_get_length(IArguments2* This,LONG *out_Count) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IHost_QueryInterface(IHost* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IHost_AddRef(IHost* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IHost_Release(IHost* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IHost_GetTypeInfoCount(IHost* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IHost_GetTypeInfo(IHost* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IHost_GetIDsOfNames(IHost* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IHost_Invoke(IHost* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IHost methods ***/
static __WIDL_INLINE HRESULT IHost_get_Name(IHost* This,BSTR *out_Name) {
    return This->lpVtbl->get_Name(This,out_Name);
}
static __WIDL_INLINE HRESULT IHost_get_Application(IHost* This,IDispatch **out_Dispatch) {
    return This->lpVtbl->get_Application(This,out_Dispatch);
}
static __WIDL_INLINE HRESULT IHost_get_FullName(IHost* This,BSTR *out_Path) {
    return This->lpVtbl->get_FullName(This,out_Path);
}
static __WIDL_INLINE HRESULT IHost_get_Path(IHost* This,BSTR *out_Path) {
    return This->lpVtbl->get_Path(This,out_Path);
}
static __WIDL_INLINE HRESULT IHost_get_Interactive(IHost* This,VARIANT_BOOL *out_Interactive) {
    return This->lpVtbl->get_Interactive(This,out_Interactive);
}
static __WIDL_INLINE HRESULT IHost_put_Interactive(IHost* This,VARIANT_BOOL out_Interactive) {
    return This->lpVtbl->put_Interactive(This,out_Interactive);
}
static __WIDL_INLINE HRESULT IHost_Quit(IHost* This,int ExitCode) {
    return This->lpVtbl->Quit(This,ExitCode);
}
static __WIDL_INLINE HRESULT IHost_get_ScriptName(IHost* This,BSTR *out_ScriptName) {
    return This->lpVtbl->get_ScriptName(This,out_ScriptName);
}
static __WIDL_INLINE HRESULT IHost_get_ScriptFullName(IHost* This,BSTR *out_ScriptFullName) {
    return This->lpVtbl->get_ScriptFullName(This,out_ScriptFullName);
}
static __WIDL_INLINE HRESULT IHost_get_Arguments(IHost* This,IArguments2 **out_Arguments) {
    return This->lpVtbl->get_Arguments(This,out_Arguments);
}
static __WIDL_INLINE HRESULT IHost_get_Version(IHost* This,BSTR *out_Version) {
    return This->lpVtbl->get_Version(This,out_Version);
}
static __WIDL_INLINE HRESULT IHost_get_BuildVersion(IHost* This,int *out_Build) {
    return This->lpVtbl->get_BuildVersion(This,out_Build);
}
static __WIDL_INLINE HRESULT IHost_get_Timeout(IHost* This,LONG *out_Timeout) {
    return This->lpVtbl->get_Timeout(This,out_Timeout);
}
static __WIDL_INLINE HRESULT IHost_put_Timeout(IHost* This,LONG out_Timeout) {
    return This->lpVtbl->put_Timeout(This,out_Timeout);
}
static __WIDL_INLINE HRESULT IHost_CreateObject(IHost* This,BSTR ProgID,BSTR Prefix,IDispatch **out_Dispatch) {
    return This->lpVtbl->CreateObject(This,ProgID,Prefix,out_Dispatch);
}
static __WIDL_INLINE HRESULT IHost_Echo(IHost* This,SAFEARRAY *pArgs) {
    return This->lpVtbl->Echo(This,pArgs);
}
static __WIDL_INLINE HRESULT IHost_GetObject(IHost* This,BSTR Pathname,BSTR ProgID,BSTR Prefix,IDispatch **out_Dispatch) {
    return This->lpVtbl->GetObject(This,Pathname,ProgID,Prefix,out_Dispatch);
}
static __WIDL_INLINE HRESULT IHost_DisconnectObject(IHost* This,IDispatch *Object) {
    return This->lpVtbl->DisconnectObject(This,Object);
}
static __WIDL_INLINE HRESULT IHost_Sleep(IHost* This,LONG Time) {
    return This->lpVtbl->Sleep(This,Time);
}
static __WIDL_INLINE HRESULT IHost_ConnectObject(IHost* This,IDispatch *Object,BSTR Prefix) {
    return This->lpVtbl->ConnectObject(This,Object,Prefix);
}
static __WIDL_INLINE HRESULT IHost_get_StdIn(IHost* This,ITextStream **out_ppts) {
    return This->lpVtbl->get_StdIn(This,out_ppts);
}
static __WIDL_INLINE HRESULT IHost_get_StdOut(IHost* This,ITextStream **ppts) {
    return This->lpVtbl->get_StdOut(This,ppts);
}
static __WIDL_INLINE HRESULT IHost_get_StdErr(IHost* This,ITextStream **ppts) {
