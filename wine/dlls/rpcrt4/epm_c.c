/*** Autogenerated by WIDL 8.6 from dlls/rpcrt4/epm.idl - Do not edit ***/
#include <string.h>
...
RPC_IF_HANDLE epm_v3_0_c_ifspec DECLSPEC_HIDDEN = (RPC_IF_HANDLE)& epm___RpcClientInterface;
    ...
    error_status_t *status)
{
    ...
    RpcTryFinally
    {
        ...
        __frame->_StubMsg.MaxCount = (ULONG_PTR)num_ents;
        ...
        *(boolean32 *)__frame->_StubMsg.Buffer = replace;
        ...
        __frame->_StubMsg.Buffer = (unsigned char *)(((ULONG_PTR)__frame->_StubMsg.Buffer + 3) & ~0x3);
        if (__frame->_StubMsg.Buffer + sizeof(error_status_t) > __frame->_StubMsg.BufferEnd)
        {
            RpcRaiseException(RPC_X_BAD_STUB_DATA);
        }
        *status = *(error_status_t *)__frame->_StubMsg.Buffer;
    ...
    error_status_t *status)
{
    ...
    if (!entry_handle) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    if (!num_ents) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    if (!status) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    RpcTryFinally
    {
        ...
        __frame->_StubMsg.BufferLength = 108;
        ...
        *num_ents = *(unsigned32 *)__frame->_StubMsg.Buffer;
        __frame->_StubMsg.Buffer += sizeof(unsigned32);
    ...
    error_status_t *status)
{
    ...
    if (!entry_handle) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    if (!num_towers) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    if (!towers) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    if (!status) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    RpcTryFinally
    {
        ...
        *num_towers = *(unsigned32 *)__frame->_StubMsg.Buffer;
        __frame->_StubMsg.Buffer += sizeof(unsigned32);
...
void __cdecl ept_lookup_handle_free(
    handle_t h,
    ept_lookup_handle_t *entry_handle,
    error_status_t *status)
{
    ...
    error_status_t *status)
{
    ...
    if (!ept_object) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    if (!status) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    RpcTryFinally
    {
