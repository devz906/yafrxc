...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionLocal_QueryInterface(ITransactionLocal* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionLocal_AddRef(ITransactionLocal* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionLocal_Release(ITransactionLocal* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransaction methods ***/
static __WIDL_INLINE HRESULT ITransactionLocal_Commit(ITransactionLocal* This,BOOL fRetaining,DWORD grfTC,DWORD grfRM) {
    return This->lpVtbl->Commit(This,fRetaining,grfTC,grfRM);
}
static __WIDL_INLINE HRESULT ITransactionLocal_Abort(ITransactionLocal* This,BOID *pboidReason,BOOL fRetaining,BOOL fAsync) {
    return This->lpVtbl->Abort(This,pboidReason,fRetaining,fAsync);
}
static __WIDL_INLINE HRESULT ITransactionLocal_GetTransactionInfo(ITransactionLocal* This,XACTTRANSINFO *pinfo) {
    return This->lpVtbl->GetTransactionInfo(This,pinfo);
}
/*** ITransactionLocal methods ***/
static __WIDL_INLINE HRESULT ITransactionLocal_GetOptionsObject(ITransactionLocal* This,ITransactionOptions **options) {
    return This->lpVtbl->GetOptionsObject(This,options);
}
static __WIDL_INLINE HRESULT ITransactionLocal_StartTransaction(ITransactionLocal* This,ISOLEVEL level,ULONG flags,ITransactionOptions *options,ULONG *trans_level) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionObject_QueryInterface(ITransactionObject* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionObject_AddRef(ITransactionObject* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionObject_Release(ITransactionObject* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionObject methods ***/
static __WIDL_INLINE HRESULT ITransactionObject_GetTransactionObject(ITransactionObject* This,ULONG level,ITransaction **transaction) {
