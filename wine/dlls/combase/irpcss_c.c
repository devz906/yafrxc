/*** Autogenerated by WIDL 8.6 from dlls/combase/irpcss.idl - Do not edit ***/
#include <string.h>
...
RPC_IF_HANDLE Irpcss_v0_0_c_ifspec DECLSPEC_HIDDEN = (RPC_IF_HANDLE)& Irpcss___RpcClientInterface;

static const MIDL_STUB_DESC Irpcss_StubDesc;

static RPC_BINDING_HANDLE Irpcss__MIDL_AutoBindHandle;

struct __frame_irpcss_server_register
{
    __DECL_EXCEPTION_FRAME
    MIDL_STUB_MESSAGE _StubMsg;
    RPC_BINDING_HANDLE _Handle;
...
static void __finally_irpcss_server_register( struct __frame_irpcss_server_register *__frame )
{
    NdrFreeBuffer(&__frame->_StubMsg);
}
...
HRESULT __cdecl irpcss_server_register(
    ...
    unsigned int *cookie)
{
    struct __frame_irpcss_server_register __f, * const __frame = &__f;
    HRESULT _RetVal;
    RPC_MESSAGE _RpcMessage;
    __frame->_Handle = 0;

    RpcExceptionInit( 0, __finally_irpcss_server_register );
    if (!clsid) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    if (!cookie) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    RpcTryFinally
    {
        NdrClientInitializeNew(&_RpcMessage, &__frame->_StubMsg, &Irpcss_StubDesc, 0);
        __frame->_Handle = handle;
        ...
        MIDL_memset(__frame->_StubMsg.Buffer, 0, (0x4 - (ULONG_PTR)__frame->_StubMsg.Buffer) & 0x3);
        __frame->_StubMsg.Buffer = (unsigned char *)(((ULONG_PTR)__frame->_StubMsg.Buffer + 3) & ~0x3);
        *(unsigned int *)__frame->_StubMsg.Buffer = flags;
        ...
        *cookie = *(unsigned int *)__frame->_StubMsg.Buffer;
        __frame->_StubMsg.Buffer += sizeof(unsigned int);
    ...
    RpcFinally
    {
        __finally_irpcss_server_register( __frame );
    }
    RpcEndFinally
...
struct __frame_irpcss_server_revoke
{
    __DECL_EXCEPTION_FRAME
    MIDL_STUB_MESSAGE _StubMsg;
    RPC_BINDING_HANDLE _Handle;
...
static void __finally_irpcss_server_revoke( struct __frame_irpcss_server_revoke *__frame )
{
    NdrFreeBuffer(&__frame->_StubMsg);
}
...
HRESULT __cdecl irpcss_server_revoke(
    ...
    unsigned int cookie)
{
    struct __frame_irpcss_server_revoke __f, * const __frame = &__f;
    HRESULT _RetVal;
    RPC_MESSAGE _RpcMessage;
    __frame->_Handle = 0;

    RpcExceptionInit( 0, __finally_irpcss_server_revoke );
    RpcTryFinally
    {
        NdrClientInitializeNew(&_RpcMessage, &__frame->_StubMsg, &Irpcss_StubDesc, 1);
        __frame->_Handle = handle;
        ...
        MIDL_memset(__frame->_StubMsg.Buffer, 0, (0x4 - (ULONG_PTR)__frame->_StubMsg.Buffer) & 0x3);
        __frame->_StubMsg.Buffer = (unsigned char *)(((ULONG_PTR)__frame->_StubMsg.Buffer + 3) & ~0x3);
        *(unsigned int *)__frame->_StubMsg.Buffer = cookie;
        __frame->_StubMsg.Buffer += sizeof(unsigned int);
        ...
        if ((_RpcMessage.DataRepresentation & 0x0000FFFFUL) != NDR_LOCAL_DATA_REPRESENTATION)
            NdrConvert(&__frame->_StubMsg, (PFORMAT_STRING)&__MIDL_ProcFormatString.Format[120]);
    ...
    RpcFinally
    {
        __finally_irpcss_server_revoke( __frame );
    }
    RpcEndFinally
...
struct __frame_irpcss_get_class_object
{
    __DECL_EXCEPTION_FRAME
    MIDL_STUB_MESSAGE _StubMsg;
    RPC_BINDING_HANDLE _Handle;
...
static void __finally_irpcss_get_class_object( struct __frame_irpcss_get_class_object *__frame )
{
    NdrFreeBuffer(&__frame->_StubMsg);
}
...
HRESULT __cdecl irpcss_get_class_object(
    ...
    PMInterfacePointer *object)
{
    struct __frame_irpcss_get_class_object __f, * const __frame = &__f;
    HRESULT _RetVal;
    RPC_MESSAGE _RpcMessage;
    __frame->_Handle = 0;

    RpcExceptionInit( 0, __finally_irpcss_get_class_object );
    if (!clsid) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    if (!object) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    RpcTryFinally
    {
        NdrClientInitializeNew(&_RpcMessage, &__frame->_StubMsg, &Irpcss_StubDesc, 2);
        __frame->_Handle = handle;
    ...
    RpcFinally
    {
        __finally_irpcss_get_class_object( __frame );
    }
    RpcEndFinally
...
struct __frame_irpcss_get_thread_seq_id
{
    __DECL_EXCEPTION_FRAME
    MIDL_STUB_MESSAGE _StubMsg;
    RPC_BINDING_HANDLE _Handle;
...
static void __finally_irpcss_get_thread_seq_id( struct __frame_irpcss_get_thread_seq_id *__frame )
{
    NdrFreeBuffer(&__frame->_StubMsg);
}
...
HRESULT __cdecl irpcss_get_thread_seq_id(
    ...
    DWORD *sequence_id)
{
    struct __frame_irpcss_get_thread_seq_id __f, * const __frame = &__f;
    HRESULT _RetVal;
    RPC_MESSAGE _RpcMessage;
    __frame->_Handle = 0;

    RpcExceptionInit( 0, __finally_irpcss_get_thread_seq_id );
    if (!sequence_id) RpcRaiseException(RPC_X_NULL_REF_POINTER);
    RpcTryFinally
    {
        NdrClientInitializeNew(&_RpcMessage, &__frame->_StubMsg, &Irpcss_StubDesc, 3);
        __frame->_Handle = handle;
        ...
        if ((_RpcMessage.DataRepresentation & 0x0000FFFFUL) != NDR_LOCAL_DATA_REPRESENTATION)
            NdrConvert(&__frame->_StubMsg, (PFORMAT_STRING)&__MIDL_ProcFormatString.Format[138]);
        ...
        *sequence_id = *(DWORD *)__frame->_StubMsg.Buffer;
        __frame->_StubMsg.Buffer += sizeof(DWORD);
    ...
    RpcFinally
    {
        __finally_irpcss_get_thread_seq_id( __frame );
    }
    RpcEndFinally
...
/* 108 (parameter flags) */
        0x4e,    /* FC_IN_PARAM_BASETYPE */
        0x08,    /* FC_LONG */
/* 110 (parameter object) */
        0x4d,    /* FC_IN_PARAM */
        0x01,
        NdrFcShort(0xd0),	/* type offset = 208 */
/* 114 (parameter cookie) */
        0x51,    /* FC_OUT_PARAM */
        0x01,
...
/* 118 (return value) */
        0x53,    /* FC_RETURN_PARAM_BASETYPE */
        0x08,    /* FC_LONG */
/* 120 (parameter handle) */
        0x4e,    /* FC_IN_PARAM_BASETYPE */
        0x0f,    /* FC_IGNORE */
/* 122 (parameter cookie) */
        0x4e,    /* FC_IN_PARAM_BASETYPE */
        0x08,    /* FC_LONG */
/* 124 (return value) */
        0x53,    /* FC_RETURN_PARAM_BASETYPE */
...
/* 136 (return value) */
        0x53,    /* FC_RETURN_PARAM_BASETYPE */
        0x08,    /* FC_LONG */
/* 138 (parameter handle) */
        0x4e,    /* FC_IN_PARAM_BASETYPE */
        0x0f,    /* FC_IGNORE */
/* 140 (parameter sequence_id) */
        0x51,    /* FC_OUT_PARAM */
        0x01,
...
/* 58 (const FILETIME *) */
        0x11, 0x0,		/* FC_RP */
        NdrFcShort(0xfff6),	/* Offset= -10 (50) */
/* 62 (IrotCookie *) */
        0x11, 0xc,	/* FC_RP [allocated_on_stack] [simple_pointer] */
        0x09,	/* FC_ULONG */
        0x5c,	/* FC_PAD */
/* 66 (IrotContextHandle *) */
        0x11, 0x0,	/* FC_RP */
...
/* 82 (PInterfaceData) */
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xffce),	/* Offset= -50 (34) */
/* 86 (PInterfaceData *) */
        0x11, 0x14,		/* FC_RP [allocated_on_stack] [pointer_deref] */
        NdrFcShort(0xfffa),	/* Offset= -6 (82) */
/* 90 (PInterfaceData) */
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xffc6),	/* Offset= -58 (34) */
/* 94 (PInterfaceData *) */
        0x11, 0x14,		/* FC_RP [allocated_on_stack] [pointer_deref] */
        NdrFcShort(0xfffa),	/* Offset= -6 (90) */
/* 98 (const MonikerComparisonData *) */
        0x11, 0x0,		/* FC_RP */
        NdrFcShort(0xffa8),	/* Offset= -88 (12) */
/* 102 (const MonikerComparisonData *) */
        0x11, 0x0,		/* FC_RP */
        NdrFcShort(0xffa4),	/* Offset= -92 (12) */
/* 106 (PInterfaceData) */
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xffb6),	/* Offset= -74 (34) */
/* 110 (PInterfaceData *) */
        0x11, 0x14,		/* FC_RP [allocated_on_stack] [pointer_deref] */
...
/* 118 (const FILETIME *) */
        0x11, 0x0,		/* FC_RP */
        NdrFcShort(0xffba),	/* Offset= -70 (50) */
/* 122 (const MonikerComparisonData *) */
        0x11, 0x0,		/* FC_RP */
        NdrFcShort(0xff90),	/* Offset= -112 (12) */
/* 126 (FILETIME *) */
        0x11, 0x4,		/* FC_RP [allocated_on_stack] */
        NdrFcShort(0xffb2),	/* Offset= -78 (50) */
/* 130 (PInterfaceData[]) */
        0x21,	/* FC_BOGUS_ARRAY */
        0x3,	/* 3 */
        NdrFcShort(0x0),	/* 0 */
        ...
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xff92),	/* Offset= -110 (34) */
        0x5c,	/* FC_PAD */
        0x5b,	/* FC_END */
/* 148 (InterfaceList) */
...
/* 174 (GUID) */
        ...
        0x0,
        NdrFcShort(0xfff1),	/* Offset= -15 (168) */
        0x5b,	/* FC_END */
/* 186 (const GUID *) */
        0x11, 0x0,		/* FC_RP */
        NdrFcShort(0xfff2),	/* Offset= -14 (174) */
/* 190 (BYTE[]) */
        0x1b,	/* FC_CARRAY */
        0x0,	/* 0 */
        NdrFcShort(0x1),	/* 1 */
        ...
        0x01,	/* FC_BYTE */
        0x5b,	/* FC_END */
/* 200 (MInterfacePointer) */
        0x17,	/* FC_CSTRUCT */
        0x3,	/* 3 */
        NdrFcShort(0x4),	/* 4 */
        NdrFcShort(0xfff2),	/* Offset= -14 (190) */
        0x08,	/* FC_LONG */
        0x5b,	/* FC_END */
/* 208 (PMInterfacePointer) */
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xfff6),	/* Offset= -10 (200) */
/* 212 (unsigned int *) */
        0x11, 0xc,	/* FC_RP [allocated_on_stack] [simple_pointer] */
        0x09,	/* FC_ULONG */
        0x5c,	/* FC_PAD */
/* 216 (const GUID *) */
        0x11, 0x0,		/* FC_RP */
        NdrFcShort(0xffd4),	/* Offset= -44 (174) */
/* 220 (PMInterfacePointer) */
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xffea),	/* Offset= -22 (200) */
/* 224 (PMInterfacePointer *) */
        0x11, 0x14,		/* FC_RP [allocated_on_stack] [pointer_deref] */
