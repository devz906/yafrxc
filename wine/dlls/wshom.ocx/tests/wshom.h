/*** Autogenerated by WIDL 8.6 from dlls/wshom.ocx/tests/wshom.idl - Do not edit ***/
...
#ifndef __IWshNetwork_FWD_DEFINED__
#define __IWshNetwork_FWD_DEFINED__
typedef interface IWshNetwork IWshNetwork;
#ifdef __cplusplus
...
#ifndef __IWshRuntimeLibrary_LIBRARY_DEFINED__
#define __IWshRuntimeLibrary_LIBRARY_DEFINED__

DEFINE_GUID(LIBID_IWshRuntimeLibrary, 0xf935dc20, 0x1cf0, 0x11d0, 0xad,0xb9, 0x00,0xc0,0x4f,0xd5,0x8a,0x0b);

typedef enum __WIDL_wshom_generated_name_0000000E {
    WshRunning = 0,
    WshFinished = 1,
    WshFailed = 2
} WshExecStatus;
typedef enum __WIDL_wshom_generated_name_0000000F {
    UnknownType = 0,
    Removable = 1,
    Fixed = 2,
    Remote = 3,
...
typedef enum __WIDL_wshom_generated_name_00000010 {
    Normal = 0x0,
    ReadOnly = 0x1,
    Hidden = 0x2,
    System = 0x4,
...
typedef enum __WIDL_wshom_generated_name_00000011 {
    ForReading = 0x1,
    ForWriting = 0x2,
    ForAppending = 0x8
} IOMode;
typedef enum __WIDL_wshom_generated_name_00000012 {
    TristateTrue = -1,
    TristateFalse = 0,
...
/*** IDrive methods ***/
static __WIDL_INLINE HRESULT IDrive_get_Path(IDrive* This,BSTR *path) {
    return This->lpVtbl->get_Path(This,path);
}
static __WIDL_INLINE HRESULT IDrive_get_DriveLetter(IDrive* This,BSTR *letter) {
    return This->lpVtbl->get_DriveLetter(This,letter);
}
static __WIDL_INLINE HRESULT IDrive_get_ShareName(IDrive* This,BSTR *ShareName) {
    return This->lpVtbl->get_ShareName(This,ShareName);
}
static __WIDL_INLINE HRESULT IDrive_get_DriveType(IDrive* This,DriveTypeConst *type) {
    return This->lpVtbl->get_DriveType(This,type);
}
static __WIDL_INLINE HRESULT IDrive_get_RootFolder(IDrive* This,IFolder **folder) {
    return This->lpVtbl->get_RootFolder(This,folder);
}
static __WIDL_INLINE HRESULT IDrive_get_AvailableSpace(IDrive* This,VARIANT *Avail) {
    return This->lpVtbl->get_AvailableSpace(This,Avail);
}
static __WIDL_INLINE HRESULT IDrive_get_FreeSpace(IDrive* This,VARIANT *pFree) {
    return This->lpVtbl->get_FreeSpace(This,pFree);
}
static __WIDL_INLINE HRESULT IDrive_get_TotalSize(IDrive* This,VARIANT *Total) {
    return This->lpVtbl->get_TotalSize(This,Total);
}
static __WIDL_INLINE HRESULT IDrive_get_VolumeName(IDrive* This,BSTR *Name) {
    return This->lpVtbl->get_VolumeName(This,Name);
}
static __WIDL_INLINE HRESULT IDrive_put_VolumeName(IDrive* This,BSTR Name) {
    return This->lpVtbl->put_VolumeName(This,Name);
}
static __WIDL_INLINE HRESULT IDrive_get_FileSystem(IDrive* This,BSTR *pFileSystem) {
    return This->lpVtbl->get_FileSystem(This,pFileSystem);
}
static __WIDL_INLINE HRESULT IDrive_get_SerialNumber(IDrive* This,LONG *SerialNumber) {
...
/*** IFile methods ***/
static __WIDL_INLINE HRESULT IFile_get_Path(IFile* This,BSTR *path) {
    return This->lpVtbl->get_Path(This,path);
}
static __WIDL_INLINE HRESULT IFile_get_Name(IFile* This,BSTR *Name) {
    return This->lpVtbl->get_Name(This,Name);
}
static __WIDL_INLINE HRESULT IFile_put_Name(IFile* This,BSTR Name) {
    return This->lpVtbl->put_Name(This,Name);
}
static __WIDL_INLINE HRESULT IFile_get_ShortPath(IFile* This,BSTR *path) {
    return This->lpVtbl->get_ShortPath(This,path);
}
static __WIDL_INLINE HRESULT IFile_get_ShortName(IFile* This,BSTR *Name) {
    return This->lpVtbl->get_ShortName(This,Name);
}
static __WIDL_INLINE HRESULT IFile_get_Drive(IFile* This,IDrive **drive) {
    return This->lpVtbl->get_Drive(This,drive);
}
static __WIDL_INLINE HRESULT IFile_get_ParentFolder(IFile* This,IFolder **folder) {
    return This->lpVtbl->get_ParentFolder(This,folder);
}
static __WIDL_INLINE HRESULT IFile_get_Attributes(IFile* This,FileAttribute *attr) {
    return This->lpVtbl->get_Attributes(This,attr);
}
static __WIDL_INLINE HRESULT IFile_put_Attributes(IFile* This,FileAttribute attr) {
    return This->lpVtbl->put_Attributes(This,attr);
}
static __WIDL_INLINE HRESULT IFile_get_DateCreated(IFile* This,DATE *date) {
    return This->lpVtbl->get_DateCreated(This,date);
}
static __WIDL_INLINE HRESULT IFile_get_DateLastModified(IFile* This,DATE *date) {
    return This->lpVtbl->get_DateLastModified(This,date);
}
static __WIDL_INLINE HRESULT IFile_get_DateLastAccessed(IFile* This,DATE *date) {
    return This->lpVtbl->get_DateLastAccessed(This,date);
}
static __WIDL_INLINE HRESULT IFile_get_Size(IFile* This,VARIANT *Size) {
    return This->lpVtbl->get_Size(This,Size);
}
static __WIDL_INLINE HRESULT IFile_get_Type(IFile* This,BSTR *Type) {
...
static __WIDL_INLINE HRESULT IFileCollection_get_Count(IFileCollection* This,LONG *count) {
...
/*** IFolder methods ***/
static __WIDL_INLINE HRESULT IFolder_get_Path(IFolder* This,BSTR *path) {
    return This->lpVtbl->get_Path(This,path);
}
static __WIDL_INLINE HRESULT IFolder_get_Name(IFolder* This,BSTR *name) {
    return This->lpVtbl->get_Name(This,name);
}
static __WIDL_INLINE HRESULT IFolder_put_Name(IFolder* This,BSTR name) {
    return This->lpVtbl->put_Name(This,name);
}
static __WIDL_INLINE HRESULT IFolder_get_ShortPath(IFolder* This,BSTR *path) {
    return This->lpVtbl->get_ShortPath(This,path);
}
static __WIDL_INLINE HRESULT IFolder_get_ShortName(IFolder* This,BSTR *name) {
    return This->lpVtbl->get_ShortName(This,name);
}
static __WIDL_INLINE HRESULT IFolder_get_Drive(IFolder* This,IDrive **drive) {
    return This->lpVtbl->get_Drive(This,drive);
}
static __WIDL_INLINE HRESULT IFolder_get_ParentFolder(IFolder* This,IFolder **folder) {
    return This->lpVtbl->get_ParentFolder(This,folder);
}
static __WIDL_INLINE HRESULT IFolder_get_Attributes(IFolder* This,FileAttribute *attr) {
    return This->lpVtbl->get_Attributes(This,attr);
}
static __WIDL_INLINE HRESULT IFolder_put_Attributes(IFolder* This,FileAttribute attr) {
    return This->lpVtbl->put_Attributes(This,attr);
}
static __WIDL_INLINE HRESULT IFolder_get_DateCreated(IFolder* This,DATE *date) {
    return This->lpVtbl->get_DateCreated(This,date);
}
static __WIDL_INLINE HRESULT IFolder_get_DateLastModified(IFolder* This,DATE *date) {
    return This->lpVtbl->get_DateLastModified(This,date);
}
static __WIDL_INLINE HRESULT IFolder_get_DateLastAccessed(IFolder* This,DATE *date) {
    return This->lpVtbl->get_DateLastAccessed(This,date);
}
static __WIDL_INLINE HRESULT IFolder_get_Type(IFolder* This,BSTR *type) {
    return This->lpVtbl->get_Type(This,type);
}
...
static __WIDL_INLINE HRESULT IFolder_get_IsRootFolder(IFolder* This,VARIANT_BOOL *root) {
    return This->lpVtbl->get_IsRootFolder(This,root);
}
static __WIDL_INLINE HRESULT IFolder_get_Size(IFolder* This,VARIANT *size) {
    return This->lpVtbl->get_Size(This,size);
}
static __WIDL_INLINE HRESULT IFolder_get_SubFolders(IFolder* This,IFolderCollection **folders) {
    return This->lpVtbl->get_SubFolders(This,folders);
}
static __WIDL_INLINE HRESULT IFolder_get_Files(IFolder* This,IFileCollection **files) {
...
/*** IFolderCollection methods ***/
static __WIDL_INLINE HRESULT IFolderCollection_Add(IFolderCollection* This,BSTR Name,IFolder **folder) {
    return This->lpVtbl->Add(This,Name,folder);
}
static __WIDL_INLINE HRESULT IFolderCollection_get_Item(IFolderCollection* This,VARIANT Key,IFolder **folder) {
...
static __WIDL_INLINE HRESULT IFolderCollection_get_Count(IFolderCollection* This,LONG *count) {
    return This->lpVtbl->get_Count(This,count);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWshCollection_QueryInterface(IWshCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWshCollection_AddRef(IWshCollection* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWshCollection_Release(IWshCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IWshCollection_GetTypeInfoCount(IWshCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IWshCollection_GetTypeInfo(IWshCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IWshCollection_GetIDsOfNames(IWshCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IWshCollection_Invoke(IWshCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshCollection methods ***/
static __WIDL_INLINE HRESULT IWshCollection_Item(IWshCollection* This,VARIANT *Index,VARIANT *out_Value) {
    return This->lpVtbl->Item(This,Index,out_Value);
}
static __WIDL_INLINE HRESULT IWshCollection_Count(IWshCollection* This,LONG *out_Count) {
    return This->lpVtbl->Count(This,out_Count);
}
static __WIDL_INLINE HRESULT IWshCollection_get_length(IWshCollection* This,LONG *out_Count) {
    return This->lpVtbl->get_length(This,out_Count);
}
static __WIDL_INLINE HRESULT IWshCollection__NewEnum(IWshCollection* This,IUnknown **out_Enum) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWshEnvironment_QueryInterface(IWshEnvironment* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWshEnvironment_AddRef(IWshEnvironment* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWshEnvironment_Release(IWshEnvironment* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IWshEnvironment_GetTypeInfoCount(IWshEnvironment* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IWshEnvironment_GetTypeInfo(IWshEnvironment* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IWshEnvironment_GetIDsOfNames(IWshEnvironment* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IWshEnvironment_Invoke(IWshEnvironment* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshEnvironment methods ***/
static __WIDL_INLINE HRESULT IWshEnvironment_get_Item(IWshEnvironment* This,BSTR Name,BSTR *out_Value) {
    return This->lpVtbl->get_Item(This,Name,out_Value);
}
static __WIDL_INLINE HRESULT IWshEnvironment_put_Item(IWshEnvironment* This,BSTR Name,BSTR Value) {
    return This->lpVtbl->put_Item(This,Name,Value);
}
static __WIDL_INLINE HRESULT IWshEnvironment_Count(IWshEnvironment* This,LONG *out_Count) {
    return This->lpVtbl->Count(This,out_Count);
}
static __WIDL_INLINE HRESULT IWshEnvironment_get_length(IWshEnvironment* This,LONG *out_Count) {
    return This->lpVtbl->get_length(This,out_Count);
}
static __WIDL_INLINE HRESULT IWshEnvironment__NewEnum(IWshEnvironment* This,IUnknown **out_Enum) {
    return This->lpVtbl->_NewEnum(This,out_Enum);
}
static __WIDL_INLINE HRESULT IWshEnvironment_Remove(IWshEnvironment* This,BSTR Name) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWshExec_QueryInterface(IWshExec* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWshExec_AddRef(IWshExec* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWshExec_Release(IWshExec* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IWshExec_GetTypeInfoCount(IWshExec* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IWshExec_GetTypeInfo(IWshExec* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IWshExec_GetIDsOfNames(IWshExec* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IWshExec_Invoke(IWshExec* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshExec methods ***/
static __WIDL_INLINE HRESULT IWshExec_get_Status(IWshExec* This,WshExecStatus *Status) {
    return This->lpVtbl->get_Status(This,Status);
}
static __WIDL_INLINE HRESULT IWshExec_get_StdIn(IWshExec* This,ITextStream **stream) {
    return This->lpVtbl->get_StdIn(This,stream);
}
static __WIDL_INLINE HRESULT IWshExec_get_StdOut(IWshExec* This,ITextStream **stream) {
    return This->lpVtbl->get_StdOut(This,stream);
}
static __WIDL_INLINE HRESULT IWshExec_get_StdErr(IWshExec* This,ITextStream **stream) {
    return This->lpVtbl->get_StdErr(This,stream);
}
static __WIDL_INLINE HRESULT IWshExec_get_ProcessID(IWshExec* This,int *pid) {
    return This->lpVtbl->get_ProcessID(This,pid);
}
static __WIDL_INLINE HRESULT IWshExec_get_ExitCode(IWshExec* This,int *code) {
    return This->lpVtbl->get_ExitCode(This,code);
}
static __WIDL_INLINE HRESULT IWshExec_Terminate(IWshExec* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWshShortcut_QueryInterface(IWshShortcut* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWshShortcut_AddRef(IWshShortcut* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWshShortcut_Release(IWshShortcut* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IWshShortcut_GetTypeInfoCount(IWshShortcut* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IWshShortcut_GetTypeInfo(IWshShortcut* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IWshShortcut_GetIDsOfNames(IWshShortcut* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IWshShortcut_Invoke(IWshShortcut* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshShortcut methods ***/
static __WIDL_INLINE HRESULT IWshShortcut_get_FullName(IWshShortcut* This,BSTR *name) {
    return This->lpVtbl->get_FullName(This,name);
}
static __WIDL_INLINE HRESULT IWshShortcut_get_Arguments(IWshShortcut* This,BSTR *Arguments) {
    return This->lpVtbl->get_Arguments(This,Arguments);
}
static __WIDL_INLINE HRESULT IWshShortcut_put_Arguments(IWshShortcut* This,BSTR Arguments) {
    return This->lpVtbl->put_Arguments(This,Arguments);
}
static __WIDL_INLINE HRESULT IWshShortcut_get_Description(IWshShortcut* This,BSTR *Description) {
    return This->lpVtbl->get_Description(This,Description);
}
static __WIDL_INLINE HRESULT IWshShortcut_put_Description(IWshShortcut* This,BSTR Description) {
    return This->lpVtbl->put_Description(This,Description);
}
static __WIDL_INLINE HRESULT IWshShortcut_get_Hotkey(IWshShortcut* This,BSTR *HotKey) {
    return This->lpVtbl->get_Hotkey(This,HotKey);
}
static __WIDL_INLINE HRESULT IWshShortcut_put_Hotkey(IWshShortcut* This,BSTR HotKey) {
    return This->lpVtbl->put_Hotkey(This,HotKey);
}
static __WIDL_INLINE HRESULT IWshShortcut_get_IconLocation(IWshShortcut* This,BSTR *IconPath) {
    return This->lpVtbl->get_IconLocation(This,IconPath);
}
static __WIDL_INLINE HRESULT IWshShortcut_put_IconLocation(IWshShortcut* This,BSTR IconPath) {
    return This->lpVtbl->put_IconLocation(This,IconPath);
}
static __WIDL_INLINE HRESULT IWshShortcut_put_RelativePath(IWshShortcut* This,BSTR rhs) {
    return This->lpVtbl->put_RelativePath(This,rhs);
}
static __WIDL_INLINE HRESULT IWshShortcut_get_TargetPath(IWshShortcut* This,BSTR *Path) {
    return This->lpVtbl->get_TargetPath(This,Path);
}
static __WIDL_INLINE HRESULT IWshShortcut_put_TargetPath(IWshShortcut* This,BSTR Path) {
    return This->lpVtbl->put_TargetPath(This,Path);
}
static __WIDL_INLINE HRESULT IWshShortcut_get_WindowStyle(IWshShortcut* This,int *ShowCmd) {
    return This->lpVtbl->get_WindowStyle(This,ShowCmd);
}
static __WIDL_INLINE HRESULT IWshShortcut_put_WindowStyle(IWshShortcut* This,int ShowCmd) {
    return This->lpVtbl->put_WindowStyle(This,ShowCmd);
}
static __WIDL_INLINE HRESULT IWshShortcut_get_WorkingDirectory(IWshShortcut* This,BSTR *WorkingDirectory) {
    return This->lpVtbl->get_WorkingDirectory(This,WorkingDirectory);
}
static __WIDL_INLINE HRESULT IWshShortcut_put_WorkingDirectory(IWshShortcut* This,BSTR WorkingDirectory) {
    return This->lpVtbl->put_WorkingDirectory(This,WorkingDirectory);
}
static __WIDL_INLINE HRESULT IWshShortcut_Load(IWshShortcut* This,BSTR PathLink) {
    return This->lpVtbl->Load(This,PathLink);
}
static __WIDL_INLINE HRESULT IWshShortcut_Save(IWshShortcut* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWshShell_QueryInterface(IWshShell* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWshShell_AddRef(IWshShell* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWshShell_Release(IWshShell* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IWshShell_GetTypeInfoCount(IWshShell* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IWshShell_GetTypeInfo(IWshShell* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IWshShell_GetIDsOfNames(IWshShell* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IWshShell_Invoke(IWshShell* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshShell methods ***/
static __WIDL_INLINE HRESULT IWshShell_get_SpecialFolders(IWshShell* This,IWshCollection **out_Folders) {
    return This->lpVtbl->get_SpecialFolders(This,out_Folders);
}
static __WIDL_INLINE HRESULT IWshShell_get_Environment(IWshShell* This,VARIANT *Type,IWshEnvironment **out_Env) {
    return This->lpVtbl->get_Environment(This,Type,out_Env);
}
static __WIDL_INLINE HRESULT IWshShell_Run(IWshShell* This,BSTR Command,VARIANT *WindowStyle,VARIANT *WaitOnReturn,int *out_ExitCode) {
    return This->lpVtbl->Run(This,Command,WindowStyle,WaitOnReturn,out_ExitCode);
}
static __WIDL_INLINE HRESULT IWshShell_Popup(IWshShell* This,BSTR Text,VARIANT *SecondsToWait,VARIANT *Title,VARIANT *Type,int *out_Button) {
    return This->lpVtbl->Popup(This,Text,SecondsToWait,Title,Type,out_Button);
}
static __WIDL_INLINE HRESULT IWshShell_CreateShortcut(IWshShell* This,BSTR PathLink,IDispatch **out_Shortcut) {
    return This->lpVtbl->CreateShortcut(This,PathLink,out_Shortcut);
}
static __WIDL_INLINE HRESULT IWshShell_ExpandEnvironmentStrings(IWshShell* This,BSTR Src,BSTR *out_Dst) {
    return This->lpVtbl->ExpandEnvironmentStrings(This,Src,out_Dst);
}
static __WIDL_INLINE HRESULT IWshShell_RegRead(IWshShell* This,BSTR Name,VARIANT *out_Value) {
    return This->lpVtbl->RegRead(This,Name,out_Value);
}
static __WIDL_INLINE HRESULT IWshShell_RegWrite(IWshShell* This,BSTR Name,VARIANT *Value,VARIANT *Type) {
    return This->lpVtbl->RegWrite(This,Name,Value,Type);
}
static __WIDL_INLINE HRESULT IWshShell_RegDelete(IWshShell* This,BSTR Name) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWshShell2_QueryInterface(IWshShell2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWshShell2_AddRef(IWshShell2* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWshShell2_Release(IWshShell2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IWshShell2_GetTypeInfoCount(IWshShell2* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IWshShell2_GetTypeInfo(IWshShell2* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IWshShell2_GetIDsOfNames(IWshShell2* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IWshShell2_Invoke(IWshShell2* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshShell methods ***/
static __WIDL_INLINE HRESULT IWshShell2_get_SpecialFolders(IWshShell2* This,IWshCollection **out_Folders) {
    return This->lpVtbl->get_SpecialFolders(This,out_Folders);
}
static __WIDL_INLINE HRESULT IWshShell2_get_Environment(IWshShell2* This,VARIANT *Type,IWshEnvironment **out_Env) {
    return This->lpVtbl->get_Environment(This,Type,out_Env);
}
static __WIDL_INLINE HRESULT IWshShell2_Run(IWshShell2* This,BSTR Command,VARIANT *WindowStyle,VARIANT *WaitOnReturn,int *out_ExitCode) {
    return This->lpVtbl->Run(This,Command,WindowStyle,WaitOnReturn,out_ExitCode);
}
static __WIDL_INLINE HRESULT IWshShell2_Popup(IWshShell2* This,BSTR Text,VARIANT *SecondsToWait,VARIANT *Title,VARIANT *Type,int *out_Button) {
    return This->lpVtbl->Popup(This,Text,SecondsToWait,Title,Type,out_Button);
}
static __WIDL_INLINE HRESULT IWshShell2_CreateShortcut(IWshShell2* This,BSTR PathLink,IDispatch **out_Shortcut) {
    return This->lpVtbl->CreateShortcut(This,PathLink,out_Shortcut);
}
static __WIDL_INLINE HRESULT IWshShell2_ExpandEnvironmentStrings(IWshShell2* This,BSTR Src,BSTR *out_Dst) {
    return This->lpVtbl->ExpandEnvironmentStrings(This,Src,out_Dst);
}
static __WIDL_INLINE HRESULT IWshShell2_RegRead(IWshShell2* This,BSTR Name,VARIANT *out_Value) {
    return This->lpVtbl->RegRead(This,Name,out_Value);
}
static __WIDL_INLINE HRESULT IWshShell2_RegWrite(IWshShell2* This,BSTR Name,VARIANT *Value,VARIANT *Type) {
    return This->lpVtbl->RegWrite(This,Name,Value,Type);
}
static __WIDL_INLINE HRESULT IWshShell2_RegDelete(IWshShell2* This,BSTR Name) {
    return This->lpVtbl->RegDelete(This,Name);
}
/*** IWshShell2 methods ***/
static __WIDL_INLINE HRESULT IWshShell2_LogEvent(IWshShell2* This,VARIANT *Type,BSTR Message,BSTR Target,VARIANT_BOOL *out_Success) {
    return This->lpVtbl->LogEvent(This,Type,Message,Target,out_Success);
}
static __WIDL_INLINE HRESULT IWshShell2_AppActivate(IWshShell2* This,VARIANT *App,VARIANT *Wait,VARIANT_BOOL *out_Success) {
    return This->lpVtbl->AppActivate(This,App,Wait,out_Success);
}
static __WIDL_INLINE HRESULT IWshShell2_SendKeys(IWshShell2* This,BSTR Keys,VARIANT *Wait) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWshShell3_QueryInterface(IWshShell3* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWshShell3_AddRef(IWshShell3* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWshShell3_Release(IWshShell3* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IWshShell3_GetTypeInfoCount(IWshShell3* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IWshShell3_GetTypeInfo(IWshShell3* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IWshShell3_GetIDsOfNames(IWshShell3* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IWshShell3_Invoke(IWshShell3* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshShell methods ***/
static __WIDL_INLINE HRESULT IWshShell3_get_SpecialFolders(IWshShell3* This,IWshCollection **out_Folders) {
    return This->lpVtbl->get_SpecialFolders(This,out_Folders);
}
static __WIDL_INLINE HRESULT IWshShell3_get_Environment(IWshShell3* This,VARIANT *Type,IWshEnvironment **out_Env) {
    return This->lpVtbl->get_Environment(This,Type,out_Env);
}
static __WIDL_INLINE HRESULT IWshShell3_Run(IWshShell3* This,BSTR Command,VARIANT *WindowStyle,VARIANT *WaitOnReturn,int *out_ExitCode) {
    return This->lpVtbl->Run(This,Command,WindowStyle,WaitOnReturn,out_ExitCode);
}
static __WIDL_INLINE HRESULT IWshShell3_Popup(IWshShell3* This,BSTR Text,VARIANT *SecondsToWait,VARIANT *Title,VARIANT *Type,int *out_Button) {
    return This->lpVtbl->Popup(This,Text,SecondsToWait,Title,Type,out_Button);
}
static __WIDL_INLINE HRESULT IWshShell3_CreateShortcut(IWshShell3* This,BSTR PathLink,IDispatch **out_Shortcut) {
    return This->lpVtbl->CreateShortcut(This,PathLink,out_Shortcut);
}
static __WIDL_INLINE HRESULT IWshShell3_ExpandEnvironmentStrings(IWshShell3* This,BSTR Src,BSTR *out_Dst) {
    return This->lpVtbl->ExpandEnvironmentStrings(This,Src,out_Dst);
}
static __WIDL_INLINE HRESULT IWshShell3_RegRead(IWshShell3* This,BSTR Name,VARIANT *out_Value) {
    return This->lpVtbl->RegRead(This,Name,out_Value);
}
static __WIDL_INLINE HRESULT IWshShell3_RegWrite(IWshShell3* This,BSTR Name,VARIANT *Value,VARIANT *Type) {
    return This->lpVtbl->RegWrite(This,Name,Value,Type);
}
static __WIDL_INLINE HRESULT IWshShell3_RegDelete(IWshShell3* This,BSTR Name) {
    return This->lpVtbl->RegDelete(This,Name);
}
/*** IWshShell2 methods ***/
static __WIDL_INLINE HRESULT IWshShell3_LogEvent(IWshShell3* This,VARIANT *Type,BSTR Message,BSTR Target,VARIANT_BOOL *out_Success) {
    return This->lpVtbl->LogEvent(This,Type,Message,Target,out_Success);
}
static __WIDL_INLINE HRESULT IWshShell3_AppActivate(IWshShell3* This,VARIANT *App,VARIANT *Wait,VARIANT_BOOL *out_Success) {
    return This->lpVtbl->AppActivate(This,App,Wait,out_Success);
}
static __WIDL_INLINE HRESULT IWshShell3_SendKeys(IWshShell3* This,BSTR Keys,VARIANT *Wait) {
    return This->lpVtbl->SendKeys(This,Keys,Wait);
}
/*** IWshShell3 methods ***/
static __WIDL_INLINE HRESULT IWshShell3_Exec(IWshShell3* This,BSTR Command,IWshExec **out_Exec) {
    return This->lpVtbl->Exec(This,Command,out_Exec);
}
static __WIDL_INLINE HRESULT IWshShell3_get_CurrentDirectory(IWshShell3* This,BSTR *out_Directory) {
    return This->lpVtbl->get_CurrentDirectory(This,out_Directory);
}
static __WIDL_INLINE HRESULT IWshShell3_put_CurrentDirectory(IWshShell3* This,BSTR out_Directory) {
...
/*****************************************************************************
 * IWshNetwork interface
 */
#ifndef __IWshNetwork_INTERFACE_DEFINED__
#define __IWshNetwork_INTERFACE_DEFINED__

DEFINE_GUID(IID_IWshNetwork, 0xf935dc25, 0x1cf0, 0x11d0, 0xad,0xb9, 0x00,0xc0,0x4f,0xd5,0x8a,0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("f935dc25-1cf0-11d0-adb9-00c04fd58a0b")
IWshNetwork : public IDispatch
{
    ...
    virtual HRESULT STDMETHODCALLTYPE get_UserProfile(
        BSTR *out_UserProfile) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_ComputerName(
        BSTR *out_ComputerName) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_Organization(
        BSTR *out_Organization) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_Site(
        BSTR *out_Site) = 0;

    virtual HRESULT STDMETHODCALLTYPE MapNetworkDrive(
        BSTR LocalName,
        BSTR RemoteName,
    ...
    virtual HRESULT STDMETHODCALLTYPE RemoveNetworkDrive(
        BSTR Name,
        VARIANT *Force,
        VARIANT *UpdateProfile) = 0;

    virtual HRESULT STDMETHODCALLTYPE EnumNetworkDrives(
        IWshCollection **out_Enum) = 0;

    virtual HRESULT STDMETHODCALLTYPE AddPrinterConnection(
        BSTR LocalName,
        BSTR RemoteName,
        VARIANT *UpdateProfile,
        VARIANT *UserName,
    ...
    virtual HRESULT STDMETHODCALLTYPE RemovePrinterConnection(
        BSTR Name,
        VARIANT *Force,
        VARIANT *UpdateProfile) = 0;

    virtual HRESULT STDMETHODCALLTYPE EnumPrinterConnections(
        IWshCollection **out_Enum) = 0;

    virtual HRESULT STDMETHODCALLTYPE SetDefaultPrinter(
        BSTR Name) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWshNetwork, 0xf935dc25, 0x1cf0, 0x11d0, 0xad,0xb9, 0x00,0xc0,0x4f,0xd5,0x8a,0x0b)
#endif
#else
typedef struct IWshNetworkVtbl {
    BEGIN_INTERFACE
    ...
    HRESULT (STDMETHODCALLTYPE *RemoveNetworkDrive)(
        IWshNetwork *This,
        BSTR Name,
        VARIANT *Force,
        VARIANT *UpdateProfile);

    HRESULT (STDMETHODCALLTYPE *EnumNetworkDrives)(
        IWshNetwork *This,
        IWshCollection **out_Enum);

    HRESULT (STDMETHODCALLTYPE *AddPrinterConnection)(
        IWshNetwork *This,
        BSTR LocalName,
        BSTR RemoteName,
        VARIANT *UpdateProfile,
    ...
    HRESULT (STDMETHODCALLTYPE *RemovePrinterConnection)(
        IWshNetwork *This,
        BSTR Name,
        VARIANT *Force,
        VARIANT *UpdateProfile);

    HRESULT (STDMETHODCALLTYPE *EnumPrinterConnections)(
        IWshNetwork *This,
        IWshCollection **out_Enum);

    HRESULT (STDMETHODCALLTYPE *SetDefaultPrinter)(
        IWshNetwork *This,
        BSTR Name);
...
interface IWshNetwork {
    CONST_VTBL IWshNetworkVtbl* lpVtbl;
};

#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IWshNetwork_QueryInterface(This,riid,ppvObject) (This)->lpVtbl->QueryInterface(This,riid,ppvObject)
#define IWshNetwork_AddRef(This) (This)->lpVtbl->AddRef(This)
#define IWshNetwork_Release(This) (This)->lpVtbl->Release(This)
/*** IDispatch methods ***/
#define IWshNetwork_GetTypeInfoCount(This,pctinfo) (This)->lpVtbl->GetTypeInfoCount(This,pctinfo)
#define IWshNetwork_GetTypeInfo(This,iTInfo,lcid,ppTInfo) (This)->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo)
#define IWshNetwork_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) (This)->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)
#define IWshNetwork_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) (This)->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)
/*** IWshNetwork methods ***/
#define IWshNetwork_get_UserDomain(This,out_UserDomain) (This)->lpVtbl->get_UserDomain(This,out_UserDomain)
#define IWshNetwork_get_UserName(This,out_UserName) (This)->lpVtbl->get_UserName(This,out_UserName)
#define IWshNetwork_get_UserProfile(This,out_UserProfile) (This)->lpVtbl->get_UserProfile(This,out_UserProfile)
#define IWshNetwork_get_ComputerName(This,out_ComputerName) (This)->lpVtbl->get_ComputerName(This,out_ComputerName)
#define IWshNetwork_get_Organization(This,out_Organization) (This)->lpVtbl->get_Organization(This,out_Organization)
#define IWshNetwork_get_Site(This,out_Site) (This)->lpVtbl->get_Site(This,out_Site)
#define IWshNetwork_MapNetworkDrive(This,LocalName,RemoteName,UpdateProfile,UserName,Password) (This)->lpVtbl->MapNetworkDrive(This,LocalName,RemoteName,UpdateProfile,UserName,Password)
#define IWshNetwork_RemoveNetworkDrive(This,Name,Force,UpdateProfile) (This)->lpVtbl->RemoveNetworkDrive(This,Name,Force,UpdateProfile)
#define IWshNetwork_EnumNetworkDrives(This,out_Enum) (This)->lpVtbl->EnumNetworkDrives(This,out_Enum)
#define IWshNetwork_AddPrinterConnection(This,LocalName,RemoteName,UpdateProfile,UserName,Password) (This)->lpVtbl->AddPrinterConnection(This,LocalName,RemoteName,UpdateProfile,UserName,Password)
#define IWshNetwork_RemovePrinterConnection(This,Name,Force,UpdateProfile) (This)->lpVtbl->RemovePrinterConnection(This,Name,Force,UpdateProfile)
#define IWshNetwork_EnumPrinterConnections(This,out_Enum) (This)->lpVtbl->EnumPrinterConnections(This,out_Enum)
#define IWshNetwork_SetDefaultPrinter(This,Name) (This)->lpVtbl->SetDefaultPrinter(This,Name)
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWshNetwork_QueryInterface(IWshNetwork* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWshNetwork_AddRef(IWshNetwork* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWshNetwork_Release(IWshNetwork* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IWshNetwork_GetTypeInfoCount(IWshNetwork* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IWshNetwork_GetTypeInfo(IWshNetwork* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IWshNetwork_GetIDsOfNames(IWshNetwork* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IWshNetwork_Invoke(IWshNetwork* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshNetwork methods ***/
static __WIDL_INLINE HRESULT IWshNetwork_get_UserDomain(IWshNetwork* This,BSTR *out_UserDomain) {
    return This->lpVtbl->get_UserDomain(This,out_UserDomain);
}
static __WIDL_INLINE HRESULT IWshNetwork_get_UserName(IWshNetwork* This,BSTR *out_UserName) {
    return This->lpVtbl->get_UserName(This,out_UserName);
}
static __WIDL_INLINE HRESULT IWshNetwork_get_UserProfile(IWshNetwork* This,BSTR *out_UserProfile) {
    return This->lpVtbl->get_UserProfile(This,out_UserProfile);
}
static __WIDL_INLINE HRESULT IWshNetwork_get_ComputerName(IWshNetwork* This,BSTR *out_ComputerName) {
    return This->lpVtbl->get_ComputerName(This,out_ComputerName);
}
static __WIDL_INLINE HRESULT IWshNetwork_get_Organization(IWshNetwork* This,BSTR *out_Organization) {
    return This->lpVtbl->get_Organization(This,out_Organization);
}
static __WIDL_INLINE HRESULT IWshNetwork_get_Site(IWshNetwork* This,BSTR *out_Site) {
    return This->lpVtbl->get_Site(This,out_Site);
}
static __WIDL_INLINE HRESULT IWshNetwork_MapNetworkDrive(IWshNetwork* This,BSTR LocalName,BSTR RemoteName,VARIANT *UpdateProfile,VARIANT *UserName,VARIANT *Password) {
    return This->lpVtbl->MapNetworkDrive(This,LocalName,RemoteName,UpdateProfile,UserName,Password);
}
static __WIDL_INLINE HRESULT IWshNetwork_RemoveNetworkDrive(IWshNetwork* This,BSTR Name,VARIANT *Force,VARIANT *UpdateProfile) {
    return This->lpVtbl->RemoveNetworkDrive(This,Name,Force,UpdateProfile);
}
static __WIDL_INLINE HRESULT IWshNetwork_EnumNetworkDrives(IWshNetwork* This,IWshCollection **out_Enum) {
    return This->lpVtbl->EnumNetworkDrives(This,out_Enum);
}
static __WIDL_INLINE HRESULT IWshNetwork_AddPrinterConnection(IWshNetwork* This,BSTR LocalName,BSTR RemoteName,VARIANT *UpdateProfile,VARIANT *UserName,VARIANT *Password) {
    return This->lpVtbl->AddPrinterConnection(This,LocalName,RemoteName,UpdateProfile,UserName,Password);
}
static __WIDL_INLINE HRESULT IWshNetwork_RemovePrinterConnection(IWshNetwork* This,BSTR Name,VARIANT *Force,VARIANT *UpdateProfile) {
    return This->lpVtbl->RemovePrinterConnection(This,Name,Force,UpdateProfile);
}
static __WIDL_INLINE HRESULT IWshNetwork_EnumPrinterConnections(IWshNetwork* This,IWshCollection **out_Enum) {
    return This->lpVtbl->EnumPrinterConnections(This,out_Enum);
}
static __WIDL_INLINE HRESULT IWshNetwork_SetDefaultPrinter(IWshNetwork* This,BSTR Name) {
    return This->lpVtbl->SetDefaultPrinter(This,Name);
}
#endif
#endif
...
#endif  /* __IWshNetwork_INTERFACE_DEFINED__ */
...
IWshNetwork2 : public IWshNetwork
{
    virtual HRESULT STDMETHODCALLTYPE AddWindowsPrinterConnection(
        BSTR PrinterName,
        BSTR DriverName = L"",
        BSTR Port = L"LPT1") = 0;
...
typedef struct IWshNetwork2Vtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *AddWindowsPrinterConnection)(
        IWshNetwork2 *This,
        BSTR PrinterName,
        BSTR DriverName,
        BSTR Port);
...
#define IWshNetwork2_get_UserName(This,out_UserName) (This)->lpVtbl->get_UserName(This,out_UserName)
#define IWshNetwork2_get_UserProfile(This,out_UserProfile) (This)->lpVtbl->get_UserProfile(This,out_UserProfile)
#define IWshNetwork2_get_ComputerName(This,out_ComputerName) (This)->lpVtbl->get_ComputerName(This,out_ComputerName)
#define IWshNetwork2_get_Organization(This,out_Organization) (This)->lpVtbl->get_Organization(This,out_Organization)
#define IWshNetwork2_get_Site(This,out_Site) (This)->lpVtbl->get_Site(This,out_Site)
#define IWshNetwork2_MapNetworkDrive(This,LocalName,RemoteName,UpdateProfile,UserName,Password) (This)->lpVtbl->MapNetworkDrive(This,LocalName,RemoteName,UpdateProfile,UserName,Password)
#define IWshNetwork2_RemoveNetworkDrive(This,Name,Force,UpdateProfile) (This)->lpVtbl->RemoveNetworkDrive(This,Name,Force,UpdateProfile)
#define IWshNetwork2_EnumNetworkDrives(This,out_Enum) (This)->lpVtbl->EnumNetworkDrives(This,out_Enum)
#define IWshNetwork2_AddPrinterConnection(This,LocalName,RemoteName,UpdateProfile,UserName,Password) (This)->lpVtbl->AddPrinterConnection(This,LocalName,RemoteName,UpdateProfile,UserName,Password)
#define IWshNetwork2_RemovePrinterConnection(This,Name,Force,UpdateProfile) (This)->lpVtbl->RemovePrinterConnection(This,Name,Force,UpdateProfile)
#define IWshNetwork2_EnumPrinterConnections(This,out_Enum) (This)->lpVtbl->EnumPrinterConnections(This,out_Enum)
#define IWshNetwork2_SetDefaultPrinter(This,Name) (This)->lpVtbl->SetDefaultPrinter(This,Name)
/*** IWshNetwork2 methods ***/
#define IWshNetwork2_AddWindowsPrinterConnection(This,PrinterName,DriverName,Port) (This)->lpVtbl->AddWindowsPrinterConnection(This,PrinterName,DriverName,Port)
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWshNetwork2_QueryInterface(IWshNetwork2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWshNetwork2_AddRef(IWshNetwork2* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWshNetwork2_Release(IWshNetwork2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IWshNetwork2_GetTypeInfoCount(IWshNetwork2* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IWshNetwork2_GetTypeInfo(IWshNetwork2* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IWshNetwork2_GetIDsOfNames(IWshNetwork2* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IWshNetwork2_Invoke(IWshNetwork2* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshNetwork methods ***/
static __WIDL_INLINE HRESULT IWshNetwork2_get_UserDomain(IWshNetwork2* This,BSTR *out_UserDomain) {
    return This->lpVtbl->get_UserDomain(This,out_UserDomain);
}
static __WIDL_INLINE HRESULT IWshNetwork2_get_UserName(IWshNetwork2* This,BSTR *out_UserName) {
    return This->lpVtbl->get_UserName(This,out_UserName);
}
static __WIDL_INLINE HRESULT IWshNetwork2_get_UserProfile(IWshNetwork2* This,BSTR *out_UserProfile) {
    return This->lpVtbl->get_UserProfile(This,out_UserProfile);
}
static __WIDL_INLINE HRESULT IWshNetwork2_get_ComputerName(IWshNetwork2* This,BSTR *out_ComputerName) {
    return This->lpVtbl->get_ComputerName(This,out_ComputerName);
}
static __WIDL_INLINE HRESULT IWshNetwork2_get_Organization(IWshNetwork2* This,BSTR *out_Organization) {
    return This->lpVtbl->get_Organization(This,out_Organization);
}
static __WIDL_INLINE HRESULT IWshNetwork2_get_Site(IWshNetwork2* This,BSTR *out_Site) {
    return This->lpVtbl->get_Site(This,out_Site);
}
static __WIDL_INLINE HRESULT IWshNetwork2_MapNetworkDrive(IWshNetwork2* This,BSTR LocalName,BSTR RemoteName,VARIANT *UpdateProfile,VARIANT *UserName,VARIANT *Password) {
    return This->lpVtbl->MapNetworkDrive(This,LocalName,RemoteName,UpdateProfile,UserName,Password);
}
static __WIDL_INLINE HRESULT IWshNetwork2_RemoveNetworkDrive(IWshNetwork2* This,BSTR Name,VARIANT *Force,VARIANT *UpdateProfile) {
    return This->lpVtbl->RemoveNetworkDrive(This,Name,Force,UpdateProfile);
}
static __WIDL_INLINE HRESULT IWshNetwork2_EnumNetworkDrives(IWshNetwork2* This,IWshCollection **out_Enum) {
    return This->lpVtbl->EnumNetworkDrives(This,out_Enum);
}
static __WIDL_INLINE HRESULT IWshNetwork2_AddPrinterConnection(IWshNetwork2* This,BSTR LocalName,BSTR RemoteName,VARIANT *UpdateProfile,VARIANT *UserName,VARIANT *Password) {
    return This->lpVtbl->AddPrinterConnection(This,LocalName,RemoteName,UpdateProfile,UserName,Password);
}
static __WIDL_INLINE HRESULT IWshNetwork2_RemovePrinterConnection(IWshNetwork2* This,BSTR Name,VARIANT *Force,VARIANT *UpdateProfile) {
    return This->lpVtbl->RemovePrinterConnection(This,Name,Force,UpdateProfile);
}
static __WIDL_INLINE HRESULT IWshNetwork2_EnumPrinterConnections(IWshNetwork2* This,IWshCollection **out_Enum) {
    return This->lpVtbl->EnumPrinterConnections(This,out_Enum);
}
static __WIDL_INLINE HRESULT IWshNetwork2_SetDefaultPrinter(IWshNetwork2* This,BSTR Name) {
    return This->lpVtbl->SetDefaultPrinter(This,Name);
}
/*** IWshNetwork2 methods ***/
static __WIDL_INLINE HRESULT IWshNetwork2_AddWindowsPrinterConnection(IWshNetwork2* This,BSTR PrinterName,BSTR DriverName,BSTR Port) {
    return This->lpVtbl->AddWindowsPrinterConnection(This,PrinterName,DriverName,Port);
}
#endif
#endif
...
#endif /* __IWshRuntimeLibrary_LIBRARY_DEFINED__ */
