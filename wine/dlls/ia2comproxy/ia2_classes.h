...
#ifndef __ia2_classes_h__
#define __ia2_classes_h__
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IAccessibleText2_QueryInterface(IAccessibleText2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IAccessibleText2_AddRef(IAccessibleText2* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IAccessibleText2_Release(IAccessibleText2* This) {
    return This->lpVtbl->Release(This);
}
/*** IAccessibleText methods ***/
static __WIDL_INLINE HRESULT IAccessibleText2_addSelection(IAccessibleText2* This,LONG startOffset,LONG endOffset) {
    return This->lpVtbl->addSelection(This,startOffset,endOffset);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_attributes(IAccessibleText2* This,LONG offset,LONG *startOffset,LONG *endOffset,BSTR *textAttributes) {
    return This->lpVtbl->get_attributes(This,offset,startOffset,endOffset,textAttributes);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_caretOffset(IAccessibleText2* This,LONG *offset) {
    return This->lpVtbl->get_caretOffset(This,offset);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_characterExtents(IAccessibleText2* This,LONG offset,enum IA2CoordinateType coordType,LONG *x,LONG *y,LONG *width,LONG *height) {
    return This->lpVtbl->get_characterExtents(This,offset,coordType,x,y,width,height);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_nSelections(IAccessibleText2* This,LONG *nSelections) {
    return This->lpVtbl->get_nSelections(This,nSelections);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_offsetAtPoint(IAccessibleText2* This,LONG x,LONG y,enum IA2CoordinateType coordType,LONG *offset) {
    return This->lpVtbl->get_offsetAtPoint(This,x,y,coordType,offset);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_selection(IAccessibleText2* This,LONG selectionIndex,LONG *startOffset,LONG *endOffset) {
    return This->lpVtbl->get_selection(This,selectionIndex,startOffset,endOffset);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_text(IAccessibleText2* This,LONG startOffset,LONG endOffset,BSTR *text) {
    return This->lpVtbl->get_text(This,startOffset,endOffset,text);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_textBeforeOffset(IAccessibleText2* This,LONG offset,enum IA2TextBoundaryType boundaryType,LONG *startOffset,LONG *endOffset,BSTR *text) {
    return This->lpVtbl->get_textBeforeOffset(This,offset,boundaryType,startOffset,endOffset,text);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_textAfterOffset(IAccessibleText2* This,LONG offset,enum IA2TextBoundaryType boundaryType,LONG *startOffset,LONG *endOffset,BSTR *text) {
    return This->lpVtbl->get_textAfterOffset(This,offset,boundaryType,startOffset,endOffset,text);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_textAtOffset(IAccessibleText2* This,LONG offset,enum IA2TextBoundaryType boundaryType,LONG *startOffset,LONG *endOffset,BSTR *text) {
    return This->lpVtbl->get_textAtOffset(This,offset,boundaryType,startOffset,endOffset,text);
}
static __WIDL_INLINE HRESULT IAccessibleText2_removeSelection(IAccessibleText2* This,LONG selectionIndex) {
    return This->lpVtbl->removeSelection(This,selectionIndex);
}
static __WIDL_INLINE HRESULT IAccessibleText2_setCaretOffset(IAccessibleText2* This,LONG offset) {
    return This->lpVtbl->setCaretOffset(This,offset);
}
static __WIDL_INLINE HRESULT IAccessibleText2_setSelection(IAccessibleText2* This,LONG selectionIndex,LONG startOffset,LONG endOffset) {
    return This->lpVtbl->setSelection(This,selectionIndex,startOffset,endOffset);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_nCharacters(IAccessibleText2* This,LONG *nCharacters) {
    return This->lpVtbl->get_nCharacters(This,nCharacters);
}
static __WIDL_INLINE HRESULT IAccessibleText2_scrollSubstringTo(IAccessibleText2* This,LONG startIndex,LONG endIndex,enum IA2ScrollType scrollType) {
    return This->lpVtbl->scrollSubstringTo(This,startIndex,endIndex,scrollType);
}
static __WIDL_INLINE HRESULT IAccessibleText2_scrollSubstringToPoint(IAccessibleText2* This,LONG startIndex,LONG endIndex,enum IA2CoordinateType coordinateType,LONG x,LONG y) {
    return This->lpVtbl->scrollSubstringToPoint(This,startIndex,endIndex,coordinateType,x,y);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_newText(IAccessibleText2* This,IA2TextSegment *newText) {
    return This->lpVtbl->get_newText(This,newText);
}
static __WIDL_INLINE HRESULT IAccessibleText2_get_oldText(IAccessibleText2* This,IA2TextSegment *oldText) {
    return This->lpVtbl->get_oldText(This,oldText);
}
/*** IAccessibleText2 methods ***/
static __WIDL_INLINE HRESULT IAccessibleText2_get_attributeRange(IAccessibleText2* This,LONG offset,BSTR filter_tmp,LONG *startOffset,LONG *endOffset,BSTR *attributeValues) {
...
DEFINE_GUID(CLSID_PSFactoryBuffer, 0x01c20f2b, 0x3dd2, 0x400f, 0x94,0x9f, 0xad,0x00,0xbd,0xab,0x1d,0x41);

#ifdef __cplusplus
class DECLSPEC_UUID("01c20f2b-3dd2-400f-949f-ad00bdab1d41") PSFactoryBuffer;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(PSFactoryBuffer, 0x01c20f2b, 0x3dd2, 0x400f, 0x94,0x9f, 0xad,0x00,0xbd,0xab,0x1d,0x41)
#endif
#endif
