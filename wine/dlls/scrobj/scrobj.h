/*** Autogenerated by WIDL 8.6 from dlls/scrobj/scrobj.idl - Do not edit ***/
...
#ifndef __Scriptlet_LIBRARY_DEFINED__
#define __Scriptlet_LIBRARY_DEFINED__
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IGenScriptletTLib_QueryInterface(IGenScriptletTLib* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IGenScriptletTLib_AddRef(IGenScriptletTLib* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IGenScriptletTLib_Release(IGenScriptletTLib* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static __WIDL_INLINE HRESULT IGenScriptletTLib_GetTypeInfoCount(IGenScriptletTLib* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_GetTypeInfo(IGenScriptletTLib* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_GetIDsOfNames(IGenScriptletTLib* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_Invoke(IGenScriptletTLib* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IGenScriptletTLib methods ***/
static __WIDL_INLINE HRESULT IGenScriptletTLib_AddURL(IGenScriptletTLib* This,BSTR url) {
    return This->lpVtbl->AddURL(This,url);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_put_Path(IGenScriptletTLib* This,BSTR path) {
    return This->lpVtbl->put_Path(This,path);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_get_Path(IGenScriptletTLib* This,BSTR *path) {
    return This->lpVtbl->get_Path(This,path);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_put_Doc(IGenScriptletTLib* This,BSTR doc) {
    return This->lpVtbl->put_Doc(This,doc);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_get_Doc(IGenScriptletTLib* This,BSTR *doc) {
    return This->lpVtbl->get_Doc(This,doc);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_put_Name(IGenScriptletTLib* This,BSTR name) {
    return This->lpVtbl->put_Name(This,name);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_get_Name(IGenScriptletTLib* This,BSTR *name) {
    return This->lpVtbl->get_Name(This,name);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_put_MajorVersion(IGenScriptletTLib* This,WORD version) {
    return This->lpVtbl->put_MajorVersion(This,version);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_get_MajorVersion(IGenScriptletTLib* This,WORD *version) {
    return This->lpVtbl->get_MajorVersion(This,version);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_put_MinorVersion(IGenScriptletTLib* This,WORD version) {
    return This->lpVtbl->put_MinorVersion(This,version);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_get_MinorVersion(IGenScriptletTLib* This,WORD *version) {
    return This->lpVtbl->get_MinorVersion(This,version);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_Write(IGenScriptletTLib* This) {
    return This->lpVtbl->Write(This);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_Reset(IGenScriptletTLib* This) {
    return This->lpVtbl->Reset(This);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_put_GUID(IGenScriptletTLib* This,BSTR guid) {
    return This->lpVtbl->put_GUID(This,guid);
}
static __WIDL_INLINE HRESULT IGenScriptletTLib_get_GUID(IGenScriptletTLib* This,BSTR *guid) {
...
#endif /* __Scriptlet_LIBRARY_DEFINED__ */
