    ...
    ULONG *pceltFetched)
{
    ...
    {
        NdrClearOutParameters( &__frame->_StubMsg, &__MIDL_TypeFormatString.Format[54], (void *)rgelt );

        NdrClearOutParameters( &__frame->_StubMsg, &__MIDL_TypeFormatString.Format[58], (void *)pceltFetched );
    ...
    IEnumSTATURL **ppenum)
{
    ...
    RpcExcept(__frame->_StubMsg.dwStubPhase != PROXY_SENDRECEIVE)
    {
        NdrClearOutParameters( &__frame->_StubMsg, &__MIDL_TypeFormatString.Format[80], (void *)ppenum );
    ...
    LPSTATURL lpSTATURL)
{
    ...
    RpcExcept(__frame->_StubMsg.dwStubPhase != PROXY_SENDRECEIVE)
    {
        NdrClearOutParameters( &__frame->_StubMsg, &__MIDL_TypeFormatString.Format[104], (void *)lpSTATURL );
    ...
    void **ppvOut)
{
    ...
    RpcExcept(__frame->_StubMsg.dwStubPhase != PROXY_SENDRECEIVE)
    {
        ...
        NdrClearOutParameters( &__frame->_StubMsg, &__MIDL_TypeFormatString.Format[140], (void *)ppvOut );
    ...
    IEnumSTATURL **ppEnum)
{
    ...
    RpcExcept(__frame->_StubMsg.dwStubPhase != PROXY_SENDRECEIVE)
    {
        NdrClearOutParameters( &__frame->_StubMsg, &__MIDL_TypeFormatString.Format[162], (void *)ppEnum );
...
/* 140 (void **) */
        0x11, 0x14,		/* FC_RP [allocated_on_stack] [pointer_deref] */
        NdrFcShort(0xfff8),	/* Offset= -8 (134) */
/* 144 (IEnumSTATURL *) */
        0x2f,	/* FC_IP */
        0x5a,	/* FC_CONSTANT_IID */
        NdrFcLong(0x3c374a42),
