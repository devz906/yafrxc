/*** Autogenerated by WIDL 8.6 from dlls/actxprxy/actxprxy_shldisp.idl - Do not edit ***/
...
#ifndef __actxprxy_shldisp_h__
#define __actxprxy_shldisp_h__
...
/*** IAutoComplete methods ***/
static __WIDL_INLINE HRESULT IAutoComplete_Init(IAutoComplete* This,HWND hwndEdit,IUnknown *punkACL,LPCOLESTR pwszRegKeyPath,LPCOLESTR pwszQuickComplete) {
    return This->lpVtbl->Init(This,hwndEdit,punkACL,pwszRegKeyPath,pwszQuickComplete);
}
static __WIDL_INLINE HRESULT IAutoComplete_Enable(IAutoComplete* This,BOOL fEnable) {
...
/*** IAutoComplete methods ***/
static __WIDL_INLINE HRESULT IAutoComplete2_Init(IAutoComplete2* This,HWND hwndEdit,IUnknown *punkACL,LPCOLESTR pwszRegKeyPath,LPCOLESTR pwszQuickComplete) {
    return This->lpVtbl->Init(This,hwndEdit,punkACL,pwszRegKeyPath,pwszQuickComplete);
}
static __WIDL_INLINE HRESULT IAutoComplete2_Enable(IAutoComplete2* This,BOOL fEnable) {
    return This->lpVtbl->Enable(This,fEnable);
}
/*** IAutoComplete2 methods ***/
...
/*** FolderItem2 methods ***/
static __WIDL_INLINE HRESULT FolderItem2_InvokeVerbEx(FolderItem2* This,VARIANT verb,VARIANT args) {
    return This->lpVtbl->InvokeVerbEx(This,verb,args);
}
static __WIDL_INLINE HRESULT FolderItem2_ExtendedProperty(FolderItem2* This,BSTR propname,VARIANT *ret) {
...
/*** FolderItems2 methods ***/
static __WIDL_INLINE HRESULT FolderItems2_InvokeVerbEx(FolderItems2* This,VARIANT verb,VARIANT args) {
    return This->lpVtbl->InvokeVerbEx(This,verb,args);
}
#endif
#endif
...
/*** FolderItems2 methods ***/
static __WIDL_INLINE HRESULT FolderItems3_InvokeVerbEx(FolderItems3* This,VARIANT verb,VARIANT args) {
    return This->lpVtbl->InvokeVerbEx(This,verb,args);
}
/*** FolderItems3 methods ***/
static __WIDL_INLINE HRESULT FolderItems3_Filter(FolderItems3* This,LONG flags,BSTR spec) {
...
static __WIDL_INLINE HRESULT IShellDispatch_ControlPanelItem(IShellDispatch* This,BSTR szDir) {
...
static __WIDL_INLINE HRESULT IShellDispatch2_ControlPanelItem(IShellDispatch2* This,BSTR szDir) {
    return This->lpVtbl->ControlPanelItem(This,szDir);
}
/*** IShellDispatch2 methods ***/
static __WIDL_INLINE HRESULT IShellDispatch2_IsRestricted(IShellDispatch2* This,BSTR group,BSTR restriction,LONG *value) {
    return This->lpVtbl->IsRestricted(This,group,restriction,value);
}
static __WIDL_INLINE HRESULT IShellDispatch2_ShellExecute(IShellDispatch2* This,BSTR file,VARIANT args,VARIANT dir,VARIANT op,VARIANT show) {
...
static __WIDL_INLINE HRESULT IShellDispatch2_GetSystemInformation(IShellDispatch2* This,BSTR name,VARIANT *ret) {
    return This->lpVtbl->GetSystemInformation(This,name,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch2_ServiceStart(IShellDispatch2* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStart(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch2_ServiceStop(IShellDispatch2* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStop(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch2_IsServiceRunning(IShellDispatch2* This,BSTR service,VARIANT *running) {
    return This->lpVtbl->IsServiceRunning(This,service,running);
}
static __WIDL_INLINE HRESULT IShellDispatch2_CanStartStopService(IShellDispatch2* This,BSTR service,VARIANT *ret) {
    return This->lpVtbl->CanStartStopService(This,service,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch2_ShowBrowserBar(IShellDispatch2* This,BSTR clsid,VARIANT show,VARIANT *ret) {
...
static __WIDL_INLINE HRESULT IShellDispatch3_ControlPanelItem(IShellDispatch3* This,BSTR szDir) {
    return This->lpVtbl->ControlPanelItem(This,szDir);
}
/*** IShellDispatch2 methods ***/
static __WIDL_INLINE HRESULT IShellDispatch3_IsRestricted(IShellDispatch3* This,BSTR group,BSTR restriction,LONG *value) {
    return This->lpVtbl->IsRestricted(This,group,restriction,value);
}
static __WIDL_INLINE HRESULT IShellDispatch3_ShellExecute(IShellDispatch3* This,BSTR file,VARIANT args,VARIANT dir,VARIANT op,VARIANT show) {
    return This->lpVtbl->ShellExecute(This,file,args,dir,op,show);
}
static __WIDL_INLINE HRESULT IShellDispatch3_FindPrinter(IShellDispatch3* This,BSTR name,BSTR location,BSTR model) {
    return This->lpVtbl->FindPrinter(This,name,location,model);
}
static __WIDL_INLINE HRESULT IShellDispatch3_GetSystemInformation(IShellDispatch3* This,BSTR name,VARIANT *ret) {
    return This->lpVtbl->GetSystemInformation(This,name,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch3_ServiceStart(IShellDispatch3* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStart(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch3_ServiceStop(IShellDispatch3* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStop(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch3_IsServiceRunning(IShellDispatch3* This,BSTR service,VARIANT *running) {
    return This->lpVtbl->IsServiceRunning(This,service,running);
}
static __WIDL_INLINE HRESULT IShellDispatch3_CanStartStopService(IShellDispatch3* This,BSTR service,VARIANT *ret) {
    return This->lpVtbl->CanStartStopService(This,service,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch3_ShowBrowserBar(IShellDispatch3* This,BSTR clsid,VARIANT show,VARIANT *ret) {
    return This->lpVtbl->ShowBrowserBar(This,clsid,show,ret);
}
/*** IShellDispatch3 methods ***/
static __WIDL_INLINE HRESULT IShellDispatch3_AddToRecent(IShellDispatch3* This,VARIANT file,BSTR category) {
...
static __WIDL_INLINE HRESULT IShellDispatch4_ControlPanelItem(IShellDispatch4* This,BSTR szDir) {
    return This->lpVtbl->ControlPanelItem(This,szDir);
}
/*** IShellDispatch2 methods ***/
static __WIDL_INLINE HRESULT IShellDispatch4_IsRestricted(IShellDispatch4* This,BSTR group,BSTR restriction,LONG *value) {
    return This->lpVtbl->IsRestricted(This,group,restriction,value);
}
static __WIDL_INLINE HRESULT IShellDispatch4_ShellExecute(IShellDispatch4* This,BSTR file,VARIANT args,VARIANT dir,VARIANT op,VARIANT show) {
    return This->lpVtbl->ShellExecute(This,file,args,dir,op,show);
}
static __WIDL_INLINE HRESULT IShellDispatch4_FindPrinter(IShellDispatch4* This,BSTR name,BSTR location,BSTR model) {
    return This->lpVtbl->FindPrinter(This,name,location,model);
}
static __WIDL_INLINE HRESULT IShellDispatch4_GetSystemInformation(IShellDispatch4* This,BSTR name,VARIANT *ret) {
    return This->lpVtbl->GetSystemInformation(This,name,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch4_ServiceStart(IShellDispatch4* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStart(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch4_ServiceStop(IShellDispatch4* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStop(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch4_IsServiceRunning(IShellDispatch4* This,BSTR service,VARIANT *running) {
    return This->lpVtbl->IsServiceRunning(This,service,running);
}
static __WIDL_INLINE HRESULT IShellDispatch4_CanStartStopService(IShellDispatch4* This,BSTR service,VARIANT *ret) {
    return This->lpVtbl->CanStartStopService(This,service,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch4_ShowBrowserBar(IShellDispatch4* This,BSTR clsid,VARIANT show,VARIANT *ret) {
    return This->lpVtbl->ShowBrowserBar(This,clsid,show,ret);
}
/*** IShellDispatch3 methods ***/
static __WIDL_INLINE HRESULT IShellDispatch4_AddToRecent(IShellDispatch4* This,VARIANT file,BSTR category) {
    return This->lpVtbl->AddToRecent(This,file,category);
}
/*** IShellDispatch4 methods ***/
...
static __WIDL_INLINE HRESULT IShellDispatch4_ExplorerPolicy(IShellDispatch4* This,BSTR policy,VARIANT *value) {
    return This->lpVtbl->ExplorerPolicy(This,policy,value);
}
static __WIDL_INLINE HRESULT IShellDispatch4_GetSetting(IShellDispatch4* This,LONG setting,VARIANT_BOOL *result) {
...
static __WIDL_INLINE HRESULT IShellDispatch5_ControlPanelItem(IShellDispatch5* This,BSTR szDir) {
    return This->lpVtbl->ControlPanelItem(This,szDir);
}
/*** IShellDispatch2 methods ***/
static __WIDL_INLINE HRESULT IShellDispatch5_IsRestricted(IShellDispatch5* This,BSTR group,BSTR restriction,LONG *value) {
    return This->lpVtbl->IsRestricted(This,group,restriction,value);
}
static __WIDL_INLINE HRESULT IShellDispatch5_ShellExecute(IShellDispatch5* This,BSTR file,VARIANT args,VARIANT dir,VARIANT op,VARIANT show) {
    return This->lpVtbl->ShellExecute(This,file,args,dir,op,show);
}
static __WIDL_INLINE HRESULT IShellDispatch5_FindPrinter(IShellDispatch5* This,BSTR name,BSTR location,BSTR model) {
    return This->lpVtbl->FindPrinter(This,name,location,model);
}
static __WIDL_INLINE HRESULT IShellDispatch5_GetSystemInformation(IShellDispatch5* This,BSTR name,VARIANT *ret) {
    return This->lpVtbl->GetSystemInformation(This,name,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch5_ServiceStart(IShellDispatch5* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStart(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch5_ServiceStop(IShellDispatch5* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStop(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch5_IsServiceRunning(IShellDispatch5* This,BSTR service,VARIANT *running) {
    return This->lpVtbl->IsServiceRunning(This,service,running);
}
static __WIDL_INLINE HRESULT IShellDispatch5_CanStartStopService(IShellDispatch5* This,BSTR service,VARIANT *ret) {
    return This->lpVtbl->CanStartStopService(This,service,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch5_ShowBrowserBar(IShellDispatch5* This,BSTR clsid,VARIANT show,VARIANT *ret) {
    return This->lpVtbl->ShowBrowserBar(This,clsid,show,ret);
}
/*** IShellDispatch3 methods ***/
static __WIDL_INLINE HRESULT IShellDispatch5_AddToRecent(IShellDispatch5* This,VARIANT file,BSTR category) {
    return This->lpVtbl->AddToRecent(This,file,category);
}
/*** IShellDispatch4 methods ***/
...
static __WIDL_INLINE HRESULT IShellDispatch5_ExplorerPolicy(IShellDispatch5* This,BSTR policy,VARIANT *value) {
    return This->lpVtbl->ExplorerPolicy(This,policy,value);
}
static __WIDL_INLINE HRESULT IShellDispatch5_GetSetting(IShellDispatch5* This,LONG setting,VARIANT_BOOL *result) {
    return This->lpVtbl->GetSetting(This,setting,result);
}
/*** IShellDispatch5 methods ***/
...
static __WIDL_INLINE HRESULT IShellDispatch6_ControlPanelItem(IShellDispatch6* This,BSTR szDir) {
    return This->lpVtbl->ControlPanelItem(This,szDir);
}
/*** IShellDispatch2 methods ***/
static __WIDL_INLINE HRESULT IShellDispatch6_IsRestricted(IShellDispatch6* This,BSTR group,BSTR restriction,LONG *value) {
    return This->lpVtbl->IsRestricted(This,group,restriction,value);
}
static __WIDL_INLINE HRESULT IShellDispatch6_ShellExecute(IShellDispatch6* This,BSTR file,VARIANT args,VARIANT dir,VARIANT op,VARIANT show) {
    return This->lpVtbl->ShellExecute(This,file,args,dir,op,show);
}
static __WIDL_INLINE HRESULT IShellDispatch6_FindPrinter(IShellDispatch6* This,BSTR name,BSTR location,BSTR model) {
    return This->lpVtbl->FindPrinter(This,name,location,model);
}
static __WIDL_INLINE HRESULT IShellDispatch6_GetSystemInformation(IShellDispatch6* This,BSTR name,VARIANT *ret) {
    return This->lpVtbl->GetSystemInformation(This,name,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch6_ServiceStart(IShellDispatch6* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStart(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch6_ServiceStop(IShellDispatch6* This,BSTR service,VARIANT persistent,VARIANT *ret) {
    return This->lpVtbl->ServiceStop(This,service,persistent,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch6_IsServiceRunning(IShellDispatch6* This,BSTR service,VARIANT *running) {
    return This->lpVtbl->IsServiceRunning(This,service,running);
}
static __WIDL_INLINE HRESULT IShellDispatch6_CanStartStopService(IShellDispatch6* This,BSTR service,VARIANT *ret) {
    return This->lpVtbl->CanStartStopService(This,service,ret);
}
static __WIDL_INLINE HRESULT IShellDispatch6_ShowBrowserBar(IShellDispatch6* This,BSTR clsid,VARIANT show,VARIANT *ret) {
    return This->lpVtbl->ShowBrowserBar(This,clsid,show,ret);
}
/*** IShellDispatch3 methods ***/
static __WIDL_INLINE HRESULT IShellDispatch6_AddToRecent(IShellDispatch6* This,VARIANT file,BSTR category) {
    return This->lpVtbl->AddToRecent(This,file,category);
}
/*** IShellDispatch4 methods ***/
...
static __WIDL_INLINE HRESULT IShellDispatch6_ExplorerPolicy(IShellDispatch6* This,BSTR policy,VARIANT *value) {
    return This->lpVtbl->ExplorerPolicy(This,policy,value);
}
static __WIDL_INLINE HRESULT IShellDispatch6_GetSetting(IShellDispatch6* This,LONG setting,VARIANT_BOOL *result) {
    return This->lpVtbl->GetSetting(This,setting,result);
}
/*** IShellDispatch5 methods ***/
...
/*** IShellFolderViewDual methods ***/
static __WIDL_INLINE HRESULT IShellFolderViewDual_get_Application(IShellFolderViewDual* This,IDispatch **app) {
    return This->lpVtbl->get_Application(This,app);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual_get_Parent(IShellFolderViewDual* This,IDispatch **parent) {
    return This->lpVtbl->get_Parent(This,parent);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual_get_Folder(IShellFolderViewDual* This,Folder **folder) {
    return This->lpVtbl->get_Folder(This,folder);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual_SelectedItems(IShellFolderViewDual* This,FolderItems **items) {
    return This->lpVtbl->SelectedItems(This,items);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual_get_FocusedItem(IShellFolderViewDual* This,FolderItem **item) {
    return This->lpVtbl->get_FocusedItem(This,item);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual_SelectItem(IShellFolderViewDual* This,VARIANT *item,int flags) {
    return This->lpVtbl->SelectItem(This,item,flags);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual_PopupItemMenu(IShellFolderViewDual* This,FolderItem *item,VARIANT vx,VARIANT vy,BSTR *command) {
    return This->lpVtbl->PopupItemMenu(This,item,vx,vy,command);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual_get_Script(IShellFolderViewDual* This,IDispatch **script) {
    return This->lpVtbl->get_Script(This,script);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual_get_ViewOptions(IShellFolderViewDual* This,LONG *options) {
...
/*** IShellFolderViewDual methods ***/
static __WIDL_INLINE HRESULT IShellFolderViewDual2_get_Application(IShellFolderViewDual2* This,IDispatch **app) {
    return This->lpVtbl->get_Application(This,app);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_get_Parent(IShellFolderViewDual2* This,IDispatch **parent) {
    return This->lpVtbl->get_Parent(This,parent);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_get_Folder(IShellFolderViewDual2* This,Folder **folder) {
    return This->lpVtbl->get_Folder(This,folder);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_SelectedItems(IShellFolderViewDual2* This,FolderItems **items) {
    return This->lpVtbl->SelectedItems(This,items);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_get_FocusedItem(IShellFolderViewDual2* This,FolderItem **item) {
    return This->lpVtbl->get_FocusedItem(This,item);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_SelectItem(IShellFolderViewDual2* This,VARIANT *item,int flags) {
    return This->lpVtbl->SelectItem(This,item,flags);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_PopupItemMenu(IShellFolderViewDual2* This,FolderItem *item,VARIANT vx,VARIANT vy,BSTR *command) {
    return This->lpVtbl->PopupItemMenu(This,item,vx,vy,command);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_get_Script(IShellFolderViewDual2* This,IDispatch **script) {
    return This->lpVtbl->get_Script(This,script);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_get_ViewOptions(IShellFolderViewDual2* This,LONG *options) {
    return This->lpVtbl->get_ViewOptions(This,options);
}
/*** IShellFolderViewDual2 methods ***/
static __WIDL_INLINE HRESULT IShellFolderViewDual2_get_CurrentViewMode(IShellFolderViewDual2* This,UINT *mode) {
    return This->lpVtbl->get_CurrentViewMode(This,mode);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_put_CurrentViewMode(IShellFolderViewDual2* This,UINT mode) {
    return This->lpVtbl->put_CurrentViewMode(This,mode);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual2_SelectItemRelative(IShellFolderViewDual2* This,int relative) {
...
/*** IShellFolderViewDual methods ***/
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_Application(IShellFolderViewDual3* This,IDispatch **app) {
    return This->lpVtbl->get_Application(This,app);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_Parent(IShellFolderViewDual3* This,IDispatch **parent) {
    return This->lpVtbl->get_Parent(This,parent);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_Folder(IShellFolderViewDual3* This,Folder **folder) {
    return This->lpVtbl->get_Folder(This,folder);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_SelectedItems(IShellFolderViewDual3* This,FolderItems **items) {
    return This->lpVtbl->SelectedItems(This,items);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_FocusedItem(IShellFolderViewDual3* This,FolderItem **item) {
    return This->lpVtbl->get_FocusedItem(This,item);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_SelectItem(IShellFolderViewDual3* This,VARIANT *item,int flags) {
    return This->lpVtbl->SelectItem(This,item,flags);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_PopupItemMenu(IShellFolderViewDual3* This,FolderItem *item,VARIANT vx,VARIANT vy,BSTR *command) {
    return This->lpVtbl->PopupItemMenu(This,item,vx,vy,command);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_Script(IShellFolderViewDual3* This,IDispatch **script) {
    return This->lpVtbl->get_Script(This,script);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_ViewOptions(IShellFolderViewDual3* This,LONG *options) {
    return This->lpVtbl->get_ViewOptions(This,options);
}
/*** IShellFolderViewDual2 methods ***/
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_CurrentViewMode(IShellFolderViewDual3* This,UINT *mode) {
    return This->lpVtbl->get_CurrentViewMode(This,mode);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_put_CurrentViewMode(IShellFolderViewDual3* This,UINT mode) {
    return This->lpVtbl->put_CurrentViewMode(This,mode);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_SelectItemRelative(IShellFolderViewDual3* This,int relative) {
    return This->lpVtbl->SelectItemRelative(This,relative);
}
/*** IShellFolderViewDual3 methods ***/
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_GroupBy(IShellFolderViewDual3* This,BSTR *groupby) {
    return This->lpVtbl->get_GroupBy(This,groupby);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_put_GroupBy(IShellFolderViewDual3* This,BSTR groupby) {
    return This->lpVtbl->put_GroupBy(This,groupby);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_FolderFlags(IShellFolderViewDual3* This,DWORD *flags) {
    return This->lpVtbl->get_FolderFlags(This,flags);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_put_FolderFlags(IShellFolderViewDual3* This,DWORD flags) {
    return This->lpVtbl->put_FolderFlags(This,flags);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_SortColumns(IShellFolderViewDual3* This,BSTR *sortcolumns) {
    return This->lpVtbl->get_SortColumns(This,sortcolumns);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_put_SortColumns(IShellFolderViewDual3* This,BSTR sortcolumns) {
    return This->lpVtbl->put_SortColumns(This,sortcolumns);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_put_IconSize(IShellFolderViewDual3* This,int icon_size) {
    return This->lpVtbl->put_IconSize(This,icon_size);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_get_IconSize(IShellFolderViewDual3* This,int *icon_size) {
    return This->lpVtbl->get_IconSize(This,icon_size);
}
static __WIDL_INLINE HRESULT IShellFolderViewDual3_FilterView(IShellFolderViewDual3* This,BSTR filter_text) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IAsyncOperation_QueryInterface(IAsyncOperation* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IAsyncOperation_AddRef(IAsyncOperation* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IAsyncOperation_Release(IAsyncOperation* This) {
    return This->lpVtbl->Release(This);
}
/*** IAsyncOperation methods ***/
static __WIDL_INLINE HRESULT IAsyncOperation_SetAsyncMode(IAsyncOperation* This,BOOL fDoOpAsync) {
    return This->lpVtbl->SetAsyncMode(This,fDoOpAsync);
}
static __WIDL_INLINE HRESULT IAsyncOperation_GetAsyncMode(IAsyncOperation* This,BOOL *pfIsOpAsync) {
    return This->lpVtbl->GetAsyncMode(This,pfIsOpAsync);
}
static __WIDL_INLINE HRESULT IAsyncOperation_StartOperation(IAsyncOperation* This,IBindCtx *pbcReserved) {
    return This->lpVtbl->StartOperation(This,pbcReserved);
}
static __WIDL_INLINE HRESULT IAsyncOperation_InOperation(IAsyncOperation* This,BOOL *pfInAsyncOp) {
    return This->lpVtbl->InOperation(This,pfInAsyncOp);
}
static __WIDL_INLINE HRESULT IAsyncOperation_EndOperation(IAsyncOperation* This,HRESULT hResult,IBindCtx *pbcReserved,DWORD dwEffects) {
