/*** Autogenerated by WIDL 8.6 from dlls/msxml3/tests/xmlparser.idl - Do not edit ***/
...
typedef enum __WIDL_xmlparser_generated_name_0000000E {
    XML_ELEMENT = 1,
    XML_ATTRIBUTE = 2,
    XML_PI = 3,
    XML_XMLDECL = 4,
...
typedef enum __WIDL_xmlparser_generated_name_0000000F {
...
typedef enum __WIDL_xmlparser_generated_name_00000010 {
...
typedef enum __WIDL_xmlparser_generated_name_00000011 {
    XMLPARSER_IDLE = 0,
    XMLPARSER_WAITING = 1,
    XMLPARSER_BUSY = 2,
    XMLPARSER_ERROR = 3,
...
typedef enum __WIDL_xmlparser_generated_name_00000012 {
...
typedef enum __WIDL_xmlparser_generated_name_00000013 {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IXMLNodeFactory_QueryInterface(IXMLNodeFactory* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IXMLNodeFactory_AddRef(IXMLNodeFactory* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IXMLNodeFactory_Release(IXMLNodeFactory* This) {
    return This->lpVtbl->Release(This);
}
/*** IXMLNodeFactory methods ***/
static __WIDL_INLINE HRESULT IXMLNodeFactory_NotifyEvent(IXMLNodeFactory* This,IXMLNodeSource *pSource,XML_NODEFACTORY_EVENT iEvt) {
    return This->lpVtbl->NotifyEvent(This,pSource,iEvt);
}
static __WIDL_INLINE HRESULT IXMLNodeFactory_BeginChildren(IXMLNodeFactory* This,IXMLNodeSource *pSource,XML_NODE_INFO *pNodeInfo) {
    return This->lpVtbl->BeginChildren(This,pSource,pNodeInfo);
}
static __WIDL_INLINE HRESULT IXMLNodeFactory_EndChildren(IXMLNodeFactory* This,IXMLNodeSource *pSource,BOOL fEmpty,XML_NODE_INFO *pNodeInfo) {
    return This->lpVtbl->EndChildren(This,pSource,fEmpty,pNodeInfo);
}
static __WIDL_INLINE HRESULT IXMLNodeFactory_Error(IXMLNodeFactory* This,IXMLNodeSource *pSource,HRESULT hrErrorCode,USHORT cNumRecs,XML_NODE_INFO **ppNodeInfo) {
    return This->lpVtbl->Error(This,pSource,hrErrorCode,cNumRecs,ppNodeInfo);
}
static __WIDL_INLINE HRESULT IXMLNodeFactory_CreateNode(IXMLNodeFactory* This,IXMLNodeSource *pSource,PVOID pNodeParent,USHORT cNumRecs,XML_NODE_INFO **ppNodeInfo) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IXMLNodeSource_QueryInterface(IXMLNodeSource* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IXMLNodeSource_AddRef(IXMLNodeSource* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IXMLNodeSource_Release(IXMLNodeSource* This) {
    return This->lpVtbl->Release(This);
}
/*** IXMLNodeSource methods ***/
static __WIDL_INLINE HRESULT IXMLNodeSource_SetFactory(IXMLNodeSource* This,IXMLNodeFactory *pNodeFactory) {
    return This->lpVtbl->SetFactory(This,pNodeFactory);
}
static __WIDL_INLINE HRESULT IXMLNodeSource_GetFactory(IXMLNodeSource* This,IXMLNodeFactory **ppNodeFactory) {
    return This->lpVtbl->GetFactory(This,ppNodeFactory);
}
static __WIDL_INLINE HRESULT IXMLNodeSource_Abort(IXMLNodeSource* This,BSTR bstrErrorInfo) {
    return This->lpVtbl->Abort(This,bstrErrorInfo);
}
static __WIDL_INLINE ULONG IXMLNodeSource_GetLineNumber(IXMLNodeSource* This) {
    return This->lpVtbl->GetLineNumber(This);
}
static __WIDL_INLINE ULONG IXMLNodeSource_GetLinePosition(IXMLNodeSource* This) {
    return This->lpVtbl->GetLinePosition(This);
}
static __WIDL_INLINE ULONG IXMLNodeSource_GetAbsolutePosition(IXMLNodeSource* This) {
    return This->lpVtbl->GetAbsolutePosition(This);
}
static __WIDL_INLINE HRESULT IXMLNodeSource_GetLineBuffer(IXMLNodeSource* This,const WCHAR **ppBuf,ULONG *Len,ULONG *StartPos) {
    return This->lpVtbl->GetLineBuffer(This,ppBuf,Len,StartPos);
}
static __WIDL_INLINE HRESULT IXMLNodeSource_GetLastError(IXMLNodeSource* This) {
    return This->lpVtbl->GetLastError(This);
}
static __WIDL_INLINE HRESULT IXMLNodeSource_GetErrorInfo(IXMLNodeSource* This,BSTR *pErrorInfo) {
    return This->lpVtbl->GetErrorInfo(This,pErrorInfo);
}
static __WIDL_INLINE ULONG IXMLNodeSource_GetFlags(IXMLNodeSource* This) {
    return This->lpVtbl->GetFlags(This);
}
static __WIDL_INLINE HRESULT IXMLNodeSource_GetURL(IXMLNodeSource* This,const WCHAR **ppBuf) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IXMLParser_QueryInterface(IXMLParser* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IXMLParser_AddRef(IXMLParser* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IXMLParser_Release(IXMLParser* This) {
    return This->lpVtbl->Release(This);
}
/*** IXMLNodeSource methods ***/
static __WIDL_INLINE HRESULT IXMLParser_SetFactory(IXMLParser* This,IXMLNodeFactory *pNodeFactory) {
    return This->lpVtbl->SetFactory(This,pNodeFactory);
}
static __WIDL_INLINE HRESULT IXMLParser_GetFactory(IXMLParser* This,IXMLNodeFactory **ppNodeFactory) {
    return This->lpVtbl->GetFactory(This,ppNodeFactory);
}
static __WIDL_INLINE HRESULT IXMLParser_Abort(IXMLParser* This,BSTR bstrErrorInfo) {
    return This->lpVtbl->Abort(This,bstrErrorInfo);
}
static __WIDL_INLINE ULONG IXMLParser_GetLineNumber(IXMLParser* This) {
    return This->lpVtbl->GetLineNumber(This);
}
static __WIDL_INLINE ULONG IXMLParser_GetLinePosition(IXMLParser* This) {
    return This->lpVtbl->GetLinePosition(This);
}
static __WIDL_INLINE ULONG IXMLParser_GetAbsolutePosition(IXMLParser* This) {
    return This->lpVtbl->GetAbsolutePosition(This);
}
static __WIDL_INLINE HRESULT IXMLParser_GetLineBuffer(IXMLParser* This,const WCHAR **ppBuf,ULONG *Len,ULONG *StartPos) {
    return This->lpVtbl->GetLineBuffer(This,ppBuf,Len,StartPos);
}
static __WIDL_INLINE HRESULT IXMLParser_GetLastError(IXMLParser* This) {
    return This->lpVtbl->GetLastError(This);
}
static __WIDL_INLINE HRESULT IXMLParser_GetErrorInfo(IXMLParser* This,BSTR *pErrorInfo) {
    return This->lpVtbl->GetErrorInfo(This,pErrorInfo);
}
static __WIDL_INLINE ULONG IXMLParser_GetFlags(IXMLParser* This) {
    return This->lpVtbl->GetFlags(This);
}
static __WIDL_INLINE HRESULT IXMLParser_GetURL(IXMLParser* This,const WCHAR **ppBuf) {
    return This->lpVtbl->GetURL(This,ppBuf);
}
/*** IXMLParser methods ***/
static __WIDL_INLINE HRESULT IXMLParser_SetURL(IXMLParser* This,const WCHAR *pszBaseUrl,const WCHAR *pszRelativeUrl,BOOL fAsync) {
    return This->lpVtbl->SetURL(This,pszBaseUrl,pszRelativeUrl,fAsync);
}
static __WIDL_INLINE HRESULT IXMLParser_Load(IXMLParser* This,BOOL fFullyAvailable,IMoniker *pimkName,LPBC pibc,DWORD grfMode) {
    return This->lpVtbl->Load(This,fFullyAvailable,pimkName,pibc,grfMode);
}
static __WIDL_INLINE HRESULT IXMLParser_SetInput(IXMLParser* This,IUnknown *pStm) {
    return This->lpVtbl->SetInput(This,pStm);
}
static __WIDL_INLINE HRESULT IXMLParser_PushData(IXMLParser* This,const char *pData,ULONG ulChars,BOOL fLastBuffer) {
    return This->lpVtbl->PushData(This,pData,ulChars,fLastBuffer);
}
static __WIDL_INLINE HRESULT IXMLParser_LoadDTD(IXMLParser* This,const WCHAR *pszBaseUrl,const WCHAR *pszRelativeUrl) {
    return This->lpVtbl->LoadDTD(This,pszBaseUrl,pszRelativeUrl);
}
static __WIDL_INLINE HRESULT IXMLParser_LoadEntity(IXMLParser* This,const WCHAR *pszBaseUrl,const WCHAR *pszRelativeUrl,BOOL fpe) {
    return This->lpVtbl->LoadEntity(This,pszBaseUrl,pszRelativeUrl,fpe);
}
static __WIDL_INLINE HRESULT IXMLParser_ParseEntity(IXMLParser* This,const WCHAR *pwcText,ULONG ulLen,BOOL fpe) {
    return This->lpVtbl->ParseEntity(This,pwcText,ulLen,fpe);
}
static __WIDL_INLINE HRESULT IXMLParser_ExpandEntity(IXMLParser* This,const WCHAR *pwcText,ULONG ulLen) {
    return This->lpVtbl->ExpandEntity(This,pwcText,ulLen);
}
static __WIDL_INLINE HRESULT IXMLParser_SetRoot(IXMLParser* This,PVOID pRoot) {
    return This->lpVtbl->SetRoot(This,pRoot);
}
static __WIDL_INLINE HRESULT IXMLParser_GetRoot(IXMLParser* This,PVOID *ppRoot) {
    return This->lpVtbl->GetRoot(This,ppRoot);
}
static __WIDL_INLINE HRESULT IXMLParser_Run(IXMLParser* This,LONG lChars) {
    return This->lpVtbl->Run(This,lChars);
}
static __WIDL_INLINE HRESULT IXMLParser_GetParserState(IXMLParser* This) {
    return This->lpVtbl->GetParserState(This);
}
static __WIDL_INLINE HRESULT IXMLParser_Suspend(IXMLParser* This) {
    return This->lpVtbl->Suspend(This);
}
static __WIDL_INLINE HRESULT IXMLParser_Reset(IXMLParser* This) {
    return This->lpVtbl->Reset(This);
}
static __WIDL_INLINE HRESULT IXMLParser_SetFlags(IXMLParser* This,ULONG iFlags) {
    return This->lpVtbl->SetFlags(This,iFlags);
}
static __WIDL_INLINE HRESULT IXMLParser_SetSecureBaseURL(IXMLParser* This,const WCHAR *pszBaseUrl) {
    return This->lpVtbl->SetSecureBaseURL(This,pszBaseUrl);
}
static __WIDL_INLINE HRESULT IXMLParser_GetSecureBaseURL(IXMLParser* This,const WCHAR **ppwcBuf) {
