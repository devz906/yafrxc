/*** Autogenerated by WIDL 8.6 from dlls/ole32/dcom.idl - Do not edit ***/
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IRemUnknown, 0x00000131, 0x0000, 0x0000, 0xc0,0x00, 0x00,0x00,0x00,0x00,0x00,0x46)
#endif
#else
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IRemUnknown_QueryInterface(IRemUnknown* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IRemUnknown_AddRef(IRemUnknown* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IRemUnknown_Release(IRemUnknown* This) {
    return This->lpVtbl->Release(This);
}
/*** IRemUnknown methods ***/
static __WIDL_INLINE HRESULT IRemUnknown_RemQueryInterface(IRemUnknown* This,REFIPID ripid,ULONG cRefs,unsigned short cIids,IID *iids,REMQIRESULT **ppQIResults) {
    return This->lpVtbl->RemQueryInterface(This,ripid,cRefs,cIids,iids,ppQIResults);
}
static __WIDL_INLINE HRESULT IRemUnknown_RemAddRef(IRemUnknown* This,unsigned short cInterfaceRefs,REMINTERFACEREF *InterfaceRefs,HRESULT *pResults) {
    return This->lpVtbl->RemAddRef(This,cInterfaceRefs,InterfaceRefs,pResults);
}
static __WIDL_INLINE HRESULT IRemUnknown_RemRelease(IRemUnknown* This,unsigned short cInterfaceRefs,REMINTERFACEREF *InterfaceRefs) {
    return This->lpVtbl->RemRelease(This,cInterfaceRefs,InterfaceRefs);
}
#endif
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IRemUnknown2, 0x00000142, 0x0000, 0x0000, 0xc0,0x00, 0x00,0x00,0x00,0x00,0x00,0x46)
#endif
#else
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IRemUnknown2_QueryInterface(IRemUnknown2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IRemUnknown2_AddRef(IRemUnknown2* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IRemUnknown2_Release(IRemUnknown2* This) {
    return This->lpVtbl->Release(This);
}
/*** IRemUnknown methods ***/
static __WIDL_INLINE HRESULT IRemUnknown2_RemQueryInterface(IRemUnknown2* This,REFIPID ripid,ULONG cRefs,unsigned short cIids,IID *iids,REMQIRESULT **ppQIResults) {
    return This->lpVtbl->RemQueryInterface(This,ripid,cRefs,cIids,iids,ppQIResults);
}
static __WIDL_INLINE HRESULT IRemUnknown2_RemAddRef(IRemUnknown2* This,unsigned short cInterfaceRefs,REMINTERFACEREF *InterfaceRefs,HRESULT *pResults) {
    return This->lpVtbl->RemAddRef(This,cInterfaceRefs,InterfaceRefs,pResults);
}
static __WIDL_INLINE HRESULT IRemUnknown2_RemRelease(IRemUnknown2* This,unsigned short cInterfaceRefs,REMINTERFACEREF *InterfaceRefs) {
    return This->lpVtbl->RemRelease(This,cInterfaceRefs,InterfaceRefs);
}
/*** IRemUnknown2 methods ***/
static __WIDL_INLINE HRESULT IRemUnknown2_RemQueryInterface2(IRemUnknown2* This,REFIPID ripid,unsigned short cIids,IID *iids,HRESULT *phr,MInterfacePointer **ppMIF) {
    return This->lpVtbl->RemQueryInterface2(This,ripid,cIids,iids,phr,ppMIF);
}
#endif
#endif
...
error_status_t __cdecl ResolveOxid(
    handle_t hRpc,
    OXID *pOxid,
...
error_status_t __cdecl SimplePing(
    handle_t hRpc,
    SETID *pSetId);

error_status_t __cdecl ComplexPing(
    handle_t hRpc,
    SETID *pSetId,
...
error_status_t __cdecl ServerAlive(
    handle_t hRpc);

error_status_t __cdecl ResolveOxid2(
    handle_t hRpc,
    OXID *pOxid,
    unsigned short cRequestedProtseqs,
    unsigned short arRequestedProtseqs[],
...
HRESULT __cdecl RemoteActivation(
    handle_t hRpc,
    ORPCTHIS *ORPCthis,
    ORPCTHAT *ORPCthat,
    GUID *Clsid,
