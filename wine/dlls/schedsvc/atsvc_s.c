/*** Autogenerated by WIDL 8.6 from dlls/schedsvc/atsvc.idl - Do not edit ***/
#include <string.h>
...
void __RPC_STUB atsvc_NetrJobEnum( PRPC_MESSAGE _pRpcMessage )
{
    ...
    RpcTryFinally
    {
        RpcTryExcept
        {
            ...
            __frame->PreferredMaximumLength = *(DWORD *)__frame->_StubMsg.Buffer;
            __frame->_StubMsg.Buffer += sizeof(DWORD);
        ...
        __frame->_RetVal = NetrJobEnum(
            ...
            __frame->PreferredMaximumLength,
