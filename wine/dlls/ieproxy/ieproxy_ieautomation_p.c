/*** Autogenerated by WIDL 8.6 from dlls/ieproxy/ieproxy_ieautomation.idl - Do not edit ***/
...
#include "ieproxy_ieautomation.h"
 ...
 */
static void __finally_IInternetExplorerManager_CreateObject_Proxy( struct __proxy_frame *__frame )
{
    NdrProxyFreeBuffer( __frame->This, &__frame->_StubMsg );
}

HRESULT STDMETHODCALLTYPE IInternetExplorerManager_CreateObject_Proxy(
    ...
    void **ppv)
{
    ...
    RpcExceptionInit( __proxy_filter, __finally_IInternetExplorerManager_CreateObject_Proxy );
    __frame->This = This;
    ...
    RpcTryExcept
    {
        ...
        RpcTryFinally
        {
            ...
            *(DWORD *)__frame->_StubMsg.Buffer = config;
        ...
        RpcFinally
        {
            __finally_IInternetExplorerManager_CreateObject_Proxy( __frame );
        }
        RpcEndFinally
    }
    RpcExcept(__frame->_StubMsg.dwStubPhase != PROXY_SENDRECEIVE)
    {
        ...
        NdrClearOutParameters( &__frame->_StubMsg, &__MIDL_TypeFormatString.Format[34], (void *)ppv );
...
struct __frame_IInternetExplorerManager_CreateObject_Stub
{
    __DECL_EXCEPTION_FRAME
    MIDL_STUB_MESSAGE _StubMsg;
    IInternetExplorerManager * _This;
    HRESULT _RetVal;
    DWORD config;
    LPCWSTR url;
    REFIID riid;
...
static void __finally_IInternetExplorerManager_CreateObject_Stub( struct __frame_IInternetExplorerManager_CreateObject_Stub *__frame )
{

    NdrPointerFree(
        &__frame->_StubMsg,
        (unsigned char *)__frame->url,
        (PFORMAT_STRING)&__MIDL_TypeFormatString.Format[2]);
...
void __RPC_STUB IInternetExplorerManager_CreateObject_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD* _pdwStubPhase)
{
    struct __frame_IInternetExplorerManager_CreateObject_Stub __f, * const __frame = &__f;

    __frame->_This = (IInternetExplorerManager*)((CStdStubBuffer*)This)->pvServerObject;

    NdrStubInitialize(_pRpcMessage, &__frame->_StubMsg, &Object_StubDesc, _pRpcChannelBuffer);

    RpcExceptionInit( 0, __finally_IInternetExplorerManager_CreateObject_Stub );
    __frame->url = 0;
    __frame->riid = 0;
    __frame->ppv = 0;
    ...
    RpcTryFinally
    {
        ...
        __frame->config = *(DWORD *)__frame->_StubMsg.Buffer;
        __frame->_StubMsg.Buffer += sizeof(DWORD);
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        ...
        __frame->_RetVal = __frame->_This->lpVtbl->CreateObject(__frame->_This, __frame->config, __frame->url, __frame->riid, __frame->ppv);
    ...
    RpcFinally
    {
        __finally_IInternetExplorerManager_CreateObject_Stub( __frame );
    }
    RpcEndFinally
    _pRpcMessage->BufferLength = __frame->_StubMsg.Buffer - (unsigned char *)_pRpcMessage->Buffer;
}

static const unsigned short IInternetExplorerManager_FormatStringOffsetTable[] =
{
    0,  /* IInternetExplorerManager::CreateObject */
};

static const CINTERFACE_PROXY_VTABLE(4) _IInternetExplorerManagerProxyVtbl =
{
    {
    ...
    },
    {
        ...
        IInternetExplorerManager_CreateObject_Proxy,
    }
};

static const MIDL_SERVER_INFO IInternetExplorerManager_ServerInfo =
{
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IInternetExplorerManager_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const PRPC_STUB_FUNCTION IInternetExplorerManager_table[] =
{
    IInternetExplorerManager_CreateObject_Stub
};

static const CInterfaceStubVtbl _IInternetExplorerManagerStubVtbl =
{
    {
        &IID_IInternetExplorerManager,
        &IInternetExplorerManager_ServerInfo,
        4,
        &IInternetExplorerManager_table[-3]
    },
    {
...
/* 34 (void **) */
        ...
        NdrFcShort(0xfff8),	/* Offset= -8 (28) */
        0x0
    }
};

static const CInterfaceProxyVtbl* const _ieproxy_ieautomation_ProxyVtblList[] =
{
    (const CInterfaceProxyVtbl*)&_IInternetExplorerManagerProxyVtbl,
    0
};

static const CInterfaceStubVtbl* const _ieproxy_ieautomation_StubVtblList[] =
{
    &_IInternetExplorerManagerStubVtbl,
    0
};

static PCInterfaceName const _ieproxy_ieautomation_InterfaceNamesList[] =
{
    "IInternetExplorerManager",
    0
};

static int __stdcall _ieproxy_ieautomation_IID_Lookup(const IID* pIID, int* pIndex)
{
    int low = 0, high = 0;
    ...
    {
        int pos = (low + high) / 2;
        int res = IID_GENERIC_CHECK_IID(_ieproxy_ieautomation, pIID, pos);
...
const ExtendedProxyFileInfo ieproxy_ieautomation_ProxyFileInfo DECLSPEC_HIDDEN =
{
    (const PCInterfaceProxyVtblList*)_ieproxy_ieautomation_ProxyVtblList,
    (const PCInterfaceStubVtblList*)_ieproxy_ieautomation_StubVtblList,
    _ieproxy_ieautomation_InterfaceNamesList,
    0,
    _ieproxy_ieautomation_IID_Lookup,
    1,
    1,
    0,
    0,
