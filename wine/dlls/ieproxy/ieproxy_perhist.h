...
#ifndef __ieproxy_perhist_h__
#define __ieproxy_perhist_h__
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IPersistHistory_QueryInterface(IPersistHistory* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IPersistHistory_AddRef(IPersistHistory* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IPersistHistory_Release(IPersistHistory* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
static __WIDL_INLINE HRESULT IPersistHistory_GetClassID(IPersistHistory* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistHistory methods ***/
static __WIDL_INLINE HRESULT IPersistHistory_LoadHistory(IPersistHistory* This,IStream *pStream,IBindCtx *pbc) {
    return This->lpVtbl->LoadHistory(This,pStream,pbc);
}
static __WIDL_INLINE HRESULT IPersistHistory_SaveHistory(IPersistHistory* This,IStream *pStream) {
    return This->lpVtbl->SaveHistory(This,pStream);
}
static __WIDL_INLINE HRESULT IPersistHistory_SetPositionCookie(IPersistHistory* This,DWORD dwPositioncookie) {
    return This->lpVtbl->SetPositionCookie(This,dwPositioncookie);
}
static __WIDL_INLINE HRESULT IPersistHistory_GetPositionCookie(IPersistHistory* This,DWORD *pdwPositioncookie) {
...
DEFINE_GUID(CLSID_PSFactoryBuffer, 0xa4a1a128, 0x768f, 0x41e0, 0xbf,0x75, 0xe4,0xfd,0xdd,0x70,0x1c,0xba);

#ifdef __cplusplus
class DECLSPEC_UUID("a4a1a128-768f-41e0-bf75-e4fddd701cba") PSFactoryBuffer;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(PSFactoryBuffer, 0xa4a1a128, 0x768f, 0x41e0, 0xbf,0x75, 0xe4,0xfd,0xdd,0x70,0x1c,0xba)
#endif
#endif
