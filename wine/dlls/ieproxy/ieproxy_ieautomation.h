...
#ifndef __ieproxy_ieautomation_h__
#define __ieproxy_ieautomation_h__
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IInternetExplorerManager_QueryInterface(IInternetExplorerManager* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IInternetExplorerManager_AddRef(IInternetExplorerManager* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IInternetExplorerManager_Release(IInternetExplorerManager* This) {
    return This->lpVtbl->Release(This);
}
/*** IInternetExplorerManager methods ***/
static __WIDL_INLINE HRESULT IInternetExplorerManager_CreateObject(IInternetExplorerManager* This,DWORD config,LPCWSTR url,REFIID riid,void **ppv) {
...
#endif /* __ieproxy_ieautomation_h__ */
